...
internal actual fun CLLocationManager.configureForLocation(permission: LocationPermission) {
...
internal actual fun CLLocationManager.isLocationServiceEnabled(): Boolean = locationServicesEnabled()
