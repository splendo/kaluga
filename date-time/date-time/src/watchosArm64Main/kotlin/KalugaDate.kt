...
actual class DefaultKalugaDate internal constructor(private val calendar: NSCalendar, initialDate: NSDate) : KalugaDate() {
    ...
    actual override var firstWeekDay: Int
        ...
        set(value) {
            calendar.firstWeekday = value.toUInt()
        }
    ...
    private fun updateDateForComponent(component: NSCalendarUnit, value: Int) {
        ...
        if (canSetComponent) {
            ...
            val calendarOptions = if (value < calendar.component(component, date)) {
            ...
            calendar.dateBySettingUnit(component, value, date, calendarOptions)
        } else {
