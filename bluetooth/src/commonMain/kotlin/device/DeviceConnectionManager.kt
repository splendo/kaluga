...
internal abstract class BaseDeviceConnectionManager(internal val deviceInfoHolder: DeviceInfoHolder, internal val repoAccessor: StateRepoAccesor<DeviceState>) {
