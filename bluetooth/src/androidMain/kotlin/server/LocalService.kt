...
actual class LocalService internal constructor(
    ...
    internal sealed class DSL(val uuid: UUID, val server: BluetoothServer) {
        ...
        class Primary(uuid: UUID, server: BluetoothServer) : DSL(uuid, server), LocalServiceDSL.Primary {
        ...
        class Secondary(uuid: UUID, server: BluetoothServer) : DSL(uuid, server), LocalServiceDSL.Secondary {
