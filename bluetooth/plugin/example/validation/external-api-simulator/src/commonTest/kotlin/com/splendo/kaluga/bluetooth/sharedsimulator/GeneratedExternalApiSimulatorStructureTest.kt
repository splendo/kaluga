...
package com.splendo.kaluga.bluetooth.sharedsimulator
...
// Stands up the generated simulated SERVER and CLIENT (implementations of the shared contract interfaces) and runs a
// read/write round-trip through them over the in-memory simulated transport — proving the external-api generation works
// end to end, not just that the types exist.
class GeneratedExternalApiSimulatorStructureTest : BaseTest() {
