 ...
 */
actual class DefaultContactsPermissionManager(private val bundle: NSBundle, contactsPermission: ContactsPermission, settings: Settings, coroutineScope: CoroutineScope) :
