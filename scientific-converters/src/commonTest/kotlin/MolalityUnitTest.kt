...
class MolalityUnitTest {
    ...
    fun molalityFromAmountOfSubstanceAndWeightTest() {
        ...
        assertEqualScientificValue(1(Decimole per Pound), 2(Decimole) / 2(Pound), round = 30)
        assertEqualScientificValue(1(Decimole per Pound.ukImperial), 2(Decimole) / 2(Pound.ukImperial), round = 30)
        assertEqualScientificValue(1(Decimole per Pound.usCustomary), 2(Decimole) / 2(Pound.usCustomary), round = 30)
    ...
    fun molalityFromMolarityAndDensityTest() {
        ...
        assertEqualScientificValue(1(Decimole per Pound), 2(Decimole per CubicFoot) / 2(Pound per CubicFoot), round = 32)
    ...
    fun molalityFromMolarityAndSpecificVolumeTest() {
        ...
        assertEqualScientificValue(4(Decimole per Pound), 2(Decimole per CubicFoot) * 2(CubicFoot per Pound), round = 30)
        assertEqualScientificValue(4(Decimole per Pound), 2(CubicFoot per Pound) * 2(Decimole per CubicFoot), round = 30)
        assertEqualScientificValue(
    ...
    fun molalityFromInvertedMolarMassTest() {
        ...
        assertEqualScientificValue(0.5(Decimole per Pound), 2(Pound per Decimole).molality(), round = 30)
        assertEqualScientificValue(0.5(Decimole per Pound.ukImperial), 2(Pound.ukImperial per Decimole).molality(), round = 30)
        assertEqualScientificValue(0.5(Decimole per Pound.ukImperial), 2(Pound.ukImperial per Decimole).molality(), round = 30)
        assertEqualScientificValue(
    ...
    fun molalityFromSpecificEnergyAndMolarEnergyTest() {
        ...
        assertEqualScientificValue(1(Decimole per Pound), 2(FootPoundForce per Pound) / 2(FootPoundForce per Decimole), round = 30)
        assertEqualScientificValue(
            1(Decimole per Pound.ukImperial),
    ...
    fun molalityFromSpecificVolumeAndMolarVolumeTest() {
        ...
        assertEqualScientificValue(1(Decimole per Pound), 2(CubicFoot per Pound) / 2(CubicFoot per Decimole), round = 30)
        assertEqualScientificValue(
            1(Decimole per Pound.ukImperial),
