...
// Inv<A> / Mul<B, B> -> Inv<Mul<Mul<A, B>, B>>
...
fun <
    ...
    targetReciprocalLeftUnitXDenominatorLeftUnit: TargetReciprocalLeftUnit.(DenominatorLeftUnit) -> TargetReciprocalUnit,
    reciprocalTargetUnit: TargetReciprocalUnit.() -> TargetUnit,
    factory: (Decimal, TargetUnit) -> TargetValue,
) = unit.inverse.numeratorReciprocalUnitXDenominatorLeftUnit(
    right.unit.left,
).targetReciprocalLeftUnitXDenominatorLeftUnit(
    right.unit.left,
