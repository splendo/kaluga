...
// Inv<A> / Div<Mul<A, B>, C> -> Div<C, Mul<Mul<A, A>, B>>

fun <
    NumeratorReciprocalAndDenominatorNumeratorLeftQuantity : UndefinedQuantityType,
    NumeratorReciprocalUnit : AbstractUndefinedScientificUnit<NumeratorReciprocalAndDenominatorNumeratorLeftQuantity>,
    NumeratorUnit : UndefinedReciprocalUnit<
        NumeratorReciprocalAndDenominatorNumeratorLeftQuantity,
        NumeratorReciprocalUnit,
        >,
    DenominatorNumeratorLeftUnit : AbstractUndefinedScientificUnit<NumeratorReciprocalAndDenominatorNumeratorLeftQuantity>,
    ...
    right: UndefinedScientificValue<
        ...
        DenominatorUnit,
        >,
    numeratorReciprocalUnitXNumeratorReciprocalUnit: NumeratorReciprocalUnit.(NumeratorReciprocalUnit) -> TargetDenominatorLeftUnit,
