...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, D>, B> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndNumeratorRightAsDenominator(
