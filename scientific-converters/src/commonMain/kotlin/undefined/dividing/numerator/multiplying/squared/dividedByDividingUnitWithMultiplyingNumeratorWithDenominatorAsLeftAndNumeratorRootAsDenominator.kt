...
// Div<Mul<A, A>, B> / Div<Mul<B, C>, A> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, B>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsLeftAndNumeratorRootAsDenominator(
