...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<D, B>, Mul<E, A>> -> Div<Mul<Mul<A, A>, Mul<E, A>>, Mul<Mul<B, C>, Mul<D, B>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndMultiplyingDenominatorWithNumeratorRootAsRight(
