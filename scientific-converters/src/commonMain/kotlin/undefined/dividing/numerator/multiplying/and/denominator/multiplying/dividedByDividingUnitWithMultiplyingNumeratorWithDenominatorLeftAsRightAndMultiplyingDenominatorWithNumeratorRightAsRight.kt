...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, C>, Mul<F, B>> -> Div<Mul<Mul<A, B>, Mul<F, B>>, Mul<Mul<C, D>, Mul<E, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndMultiplyingDenominatorWithNumeratorRightAsRight(
