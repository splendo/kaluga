...
// Div<Mul<A, B>, C> / Div<Mul<C, D>, Mul<E, B>> -> Div<Mul<Mul<A, B>, Mul<E, B>>, Mul<Mul<C, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsLeftAndMultiplyingDenominatorWithNumeratorRightAsRight(
