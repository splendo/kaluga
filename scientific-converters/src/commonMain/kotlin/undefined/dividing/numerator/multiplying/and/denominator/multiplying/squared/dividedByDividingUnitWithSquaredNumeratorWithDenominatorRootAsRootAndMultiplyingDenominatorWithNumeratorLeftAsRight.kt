...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, C>, Mul<D, A>> -> Div<Mul<Mul<A, B>, Mul<D, A>>, Mul<Mul<C, C>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRootAsRootAndMultiplyingDenominatorWithNumeratorLeftAsRight(
