...
// Div<Mul<A, B>, C> / Div<Mul<A, C>, Mul<B, D>> -> Div<Mul<Mul<B, B>, D>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorLeftAsLeftAndDenominatorAsRightAndMultiplyingDenominatorWithNumeratorRightAsLeft(
