...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, C>, Mul<A, F>> -> Div<Mul<Mul<A, B>, Mul<A, F>>, Mul<Mul<C, D>, Mul<E, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
