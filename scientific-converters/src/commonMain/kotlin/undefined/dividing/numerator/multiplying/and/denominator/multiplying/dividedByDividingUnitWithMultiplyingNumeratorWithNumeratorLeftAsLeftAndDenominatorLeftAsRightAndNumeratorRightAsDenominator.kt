...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<A, C>, B> -> Div<Mul<B, B>, Mul<Mul<C, D>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorLeftAsLeftAndDenominatorLeftAsRightAndNumeratorRightAsDenominator(
