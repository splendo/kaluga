...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, C>, B> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, C>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRootAsRootAndNumeratorRightAsDenominator(
