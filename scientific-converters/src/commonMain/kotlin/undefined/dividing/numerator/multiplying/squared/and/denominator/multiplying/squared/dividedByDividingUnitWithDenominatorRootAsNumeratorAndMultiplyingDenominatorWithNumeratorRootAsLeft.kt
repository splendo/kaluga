...
// Div<Mul<A, A>, Mul<B, B>> / Div<B, Mul<A, C>> -> Div<Mul<Mul<A, A>, Mul<A, C>>, Mul<Mul<B, B>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRootAsNumeratorAndMultiplyingDenominatorWithNumeratorRootAsLeft(
