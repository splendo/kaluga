...
// Div<Mul<A, B>, Mul<D, C>> / Div<D, Mul<E, A>> -> Div<Mul<Mul<A, B>, Mul<E, A>>, Mul<Mul<D, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorLeftAsNumeratorAndMultiplyingDenominatorWithNumeratorLeftAsRight(
