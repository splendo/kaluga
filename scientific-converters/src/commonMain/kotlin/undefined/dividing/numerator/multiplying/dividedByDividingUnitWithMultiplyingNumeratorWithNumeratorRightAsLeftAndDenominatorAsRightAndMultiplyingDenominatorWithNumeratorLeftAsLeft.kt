...
// Div<Mul<A, B>, C> / Div<Mul<B, C>, Mul<A, D>> -> Div<Mul<Mul<A, A>, D>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorRightAsLeftAndDenominatorAsRightAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
