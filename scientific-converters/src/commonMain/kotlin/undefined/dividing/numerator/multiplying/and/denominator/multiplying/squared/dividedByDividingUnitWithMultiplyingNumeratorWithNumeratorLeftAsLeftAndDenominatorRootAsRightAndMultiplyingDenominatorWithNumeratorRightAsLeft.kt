...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<A, C>, Mul<B, D>> -> Div<Mul<Mul<B, B>, D>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorLeftAsLeftAndDenominatorRootAsRightAndMultiplyingDenominatorWithNumeratorRightAsLeft(
