...
// Div<Mul<A, B>, Mul<C, D>> / Div<E, Mul<B, C>> -> Div<Mul<Mul<A, B>, B>, Mul<D, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithNumeratorRightAsLeftAndDenominatorLeftAsRight(
