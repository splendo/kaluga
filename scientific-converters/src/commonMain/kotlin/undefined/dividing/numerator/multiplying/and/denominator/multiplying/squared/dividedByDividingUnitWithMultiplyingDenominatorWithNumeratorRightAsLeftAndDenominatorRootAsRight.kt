...
// Div<Mul<A, B>, Mul<C, C>> / Div<D, Mul<B, C>> -> Div<Mul<Mul<A, B>, B>, Mul<C, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithNumeratorRightAsLeftAndDenominatorRootAsRight(
