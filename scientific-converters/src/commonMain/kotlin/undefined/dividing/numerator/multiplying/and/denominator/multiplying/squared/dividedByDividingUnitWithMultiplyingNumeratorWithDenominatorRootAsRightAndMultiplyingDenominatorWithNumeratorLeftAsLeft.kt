...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<D, C>, Mul<A, E>> -> Div<Mul<Mul<A, B>, Mul<A, E>>, Mul<Mul<C, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsRightAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
