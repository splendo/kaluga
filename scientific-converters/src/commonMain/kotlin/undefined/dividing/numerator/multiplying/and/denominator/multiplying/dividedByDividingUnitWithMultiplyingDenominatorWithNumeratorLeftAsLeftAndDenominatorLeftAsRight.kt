...
// Div<Mul<A, B>, Mul<C, D>> / Div<E, Mul<A, C>> -> Div<Mul<Mul<A, B>, A>, Mul<D, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithNumeratorLeftAsLeftAndDenominatorLeftAsRight(
