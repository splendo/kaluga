...
// Div<Mul<A, B>, C> / Div<Mul<C, D>, Mul<A, A>> -> Div<Mul<Mul<A, B>, Mul<A, A>>, Mul<Mul<C, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsLeftAndSquaredDenominatorWithNumeratorLeftAsRoot(
