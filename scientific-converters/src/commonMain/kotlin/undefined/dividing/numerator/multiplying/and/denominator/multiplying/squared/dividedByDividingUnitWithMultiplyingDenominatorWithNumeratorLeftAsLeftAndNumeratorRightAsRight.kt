...
// Div<Mul<A, B>, Mul<C, C>> / Div<D, Mul<A, B>> -> Div<Mul<Mul<A, B>, Mul<A, B>>, Mul<Mul<C, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithNumeratorLeftAsLeftAndNumeratorRightAsRight(
