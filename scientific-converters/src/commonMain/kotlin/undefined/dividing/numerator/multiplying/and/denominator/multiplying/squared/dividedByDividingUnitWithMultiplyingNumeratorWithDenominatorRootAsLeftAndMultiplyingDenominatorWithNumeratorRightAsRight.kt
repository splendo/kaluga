...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, D>, Mul<E, B>> -> Div<Mul<Mul<A, B>, Mul<E, B>>, Mul<Mul<C, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndMultiplyingDenominatorWithNumeratorRightAsRight(
