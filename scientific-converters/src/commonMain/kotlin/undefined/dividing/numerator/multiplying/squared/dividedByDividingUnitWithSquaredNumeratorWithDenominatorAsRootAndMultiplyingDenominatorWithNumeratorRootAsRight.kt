...
// Div<Mul<A, A>, B> / Div<Mul<B, B>, Mul<C, A>> -> Div<Mul<Mul<A, A>, Mul<C, A>>, Mul<Mul<B, B>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorAsRootAndMultiplyingDenominatorWithNumeratorRootAsRight(
