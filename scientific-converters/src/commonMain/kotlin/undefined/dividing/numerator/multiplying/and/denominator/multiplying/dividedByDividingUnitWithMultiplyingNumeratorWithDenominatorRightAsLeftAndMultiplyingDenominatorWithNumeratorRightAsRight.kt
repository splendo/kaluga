...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, E>, Mul<F, B>> -> Div<Mul<Mul<A, B>, Mul<F, B>>, Mul<Mul<C, D>, Mul<D, E>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndMultiplyingDenominatorWithNumeratorRightAsRight(
