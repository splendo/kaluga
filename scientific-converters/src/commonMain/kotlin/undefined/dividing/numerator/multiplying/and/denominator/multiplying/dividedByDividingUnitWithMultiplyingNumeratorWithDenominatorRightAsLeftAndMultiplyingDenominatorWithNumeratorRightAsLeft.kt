...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, E>, Mul<B, F>> -> Div<Mul<Mul<A, B>, Mul<B, F>>, Mul<Mul<C, D>, Mul<D, E>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndMultiplyingDenominatorWithNumeratorRightAsLeft(
