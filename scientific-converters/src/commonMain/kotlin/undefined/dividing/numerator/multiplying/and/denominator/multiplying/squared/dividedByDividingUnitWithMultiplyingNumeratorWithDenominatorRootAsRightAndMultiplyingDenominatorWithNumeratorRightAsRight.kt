...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<D, C>, Mul<E, B>> -> Div<Mul<Mul<A, B>, Mul<E, B>>, Mul<Mul<C, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsRightAndMultiplyingDenominatorWithNumeratorRightAsRight(
