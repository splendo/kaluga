...
// Div<Mul<A, B>, Mul<C, D>> / Div<E, Mul<A, D>> -> Div<Mul<Mul<A, B>, A>, Mul<C, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithNumeratorLeftAsLeftAndDenominatorRightAsRight(
