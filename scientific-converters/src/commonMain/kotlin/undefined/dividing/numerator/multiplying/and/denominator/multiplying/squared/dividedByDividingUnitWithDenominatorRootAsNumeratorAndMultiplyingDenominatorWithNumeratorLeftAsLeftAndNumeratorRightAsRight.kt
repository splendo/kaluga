...
// Div<Mul<A, B>, Mul<C, C>> / Div<C, Mul<A, B>> -> Div<Mul<Mul<A, B>, Mul<A, B>>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRootAsNumeratorAndMultiplyingDenominatorWithNumeratorLeftAsLeftAndNumeratorRightAsRight(
