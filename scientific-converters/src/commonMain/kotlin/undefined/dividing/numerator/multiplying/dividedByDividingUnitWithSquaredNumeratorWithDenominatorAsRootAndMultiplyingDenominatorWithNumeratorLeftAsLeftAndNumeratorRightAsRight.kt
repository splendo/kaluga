...
// Div<Mul<A, B>, C> / Div<Mul<C, C>, Mul<A, B>> -> Div<Mul<Mul<A, B>, Mul<A, B>>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorAsRootAndMultiplyingDenominatorWithNumeratorLeftAsLeftAndNumeratorRightAsRight(
