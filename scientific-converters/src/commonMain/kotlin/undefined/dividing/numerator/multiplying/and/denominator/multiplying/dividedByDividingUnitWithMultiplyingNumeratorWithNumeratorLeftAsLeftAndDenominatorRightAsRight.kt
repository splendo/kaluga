...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<A, D>, E> -> Div<Mul<B, E>, Mul<Mul<C, D>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorLeftAsLeftAndDenominatorRightAsRight(
