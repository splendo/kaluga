...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, E>, Mul<C, C>> -> Div<Mul<Mul<A, B>, C>, Mul<Mul<D, D>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndSquaredDenominatorWithDenominatorLeftAsRoot(
