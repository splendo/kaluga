...
// Div<Mul<A, B>, C> / Div<Mul<D, C>, Mul<E, B>> -> Div<Mul<Mul<A, B>, Mul<E, B>>, Mul<Mul<C, D>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsRightAndMultiplyingDenominatorWithNumeratorRightAsRight(
