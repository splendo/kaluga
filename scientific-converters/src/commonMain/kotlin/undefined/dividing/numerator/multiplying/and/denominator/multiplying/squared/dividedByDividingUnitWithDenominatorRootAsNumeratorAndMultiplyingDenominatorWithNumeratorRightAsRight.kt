...
// Div<Mul<A, B>, Mul<C, C>> / Div<C, Mul<D, B>> -> Div<Mul<Mul<A, B>, Mul<D, B>>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRootAsNumeratorAndMultiplyingDenominatorWithNumeratorRightAsRight(
