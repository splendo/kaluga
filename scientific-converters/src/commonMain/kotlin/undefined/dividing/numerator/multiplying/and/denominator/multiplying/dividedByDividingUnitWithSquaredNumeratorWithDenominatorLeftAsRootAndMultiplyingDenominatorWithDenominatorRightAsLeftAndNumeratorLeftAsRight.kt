...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, C>, Mul<D, A>> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorLeftAsRootAndMultiplyingDenominatorWithDenominatorRightAsLeftAndNumeratorLeftAsRight(
