...
// Div<Mul<A, B>, C> / Div<C, Mul<B, B>> -> Div<Mul<Mul<A, B>, Mul<B, B>>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorAsNumeratorAndSquaredDenominatorWithNumeratorRightAsRoot(
