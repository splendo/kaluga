...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<D, C>, A> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsRightAndNumeratorRootAsDenominator(
