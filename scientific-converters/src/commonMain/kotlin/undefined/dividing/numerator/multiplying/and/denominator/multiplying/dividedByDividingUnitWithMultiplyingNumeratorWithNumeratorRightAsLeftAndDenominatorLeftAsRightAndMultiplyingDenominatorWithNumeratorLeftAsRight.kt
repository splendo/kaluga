...
// Div<Mul<A, B>, Mul<D, C>> / Div<Mul<B, D>, Mul<E, A>> -> Div<Mul<Mul<A, E>, A>, Mul<Mul<D, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorRightAsLeftAndDenominatorLeftAsRightAndMultiplyingDenominatorWithNumeratorLeftAsRight(
