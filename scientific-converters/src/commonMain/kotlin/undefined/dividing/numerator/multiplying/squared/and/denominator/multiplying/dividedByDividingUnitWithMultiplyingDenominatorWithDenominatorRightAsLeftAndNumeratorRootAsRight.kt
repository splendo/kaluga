...
// Div<Mul<A, A>, Mul<B, C>> / Div<D, Mul<C, A>> -> Div<Mul<Mul<A, A>, A>, Mul<B, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithDenominatorRightAsLeftAndNumeratorRootAsRight(
