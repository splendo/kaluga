...
// Div<Mul<A, A>, Mul<C, B>> / Div<Mul<A, C>, D> -> Div<Mul<A, D>, Mul<Mul<C, B>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorRootAsLeftAndDenominatorLeftAsRight(
