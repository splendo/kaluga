...
// Div<Mul<A, B>, C> / Div<C, Mul<A, A>> -> Div<Mul<Mul<A, B>, Mul<A, A>>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorAsNumeratorAndSquaredDenominatorWithNumeratorLeftAsRoot(
