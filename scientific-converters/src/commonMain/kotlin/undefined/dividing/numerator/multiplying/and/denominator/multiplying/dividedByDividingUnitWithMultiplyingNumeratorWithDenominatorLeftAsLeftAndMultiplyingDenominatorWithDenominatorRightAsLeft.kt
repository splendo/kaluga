...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, E>, Mul<D, F>> -> Div<Mul<Mul<A, B>, F>, Mul<Mul<C, C>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndMultiplyingDenominatorWithDenominatorRightAsLeft(
