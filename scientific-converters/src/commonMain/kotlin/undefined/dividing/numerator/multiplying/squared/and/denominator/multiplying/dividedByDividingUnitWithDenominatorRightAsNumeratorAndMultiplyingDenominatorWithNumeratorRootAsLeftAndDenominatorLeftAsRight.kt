...
// Div<Mul<A, A>, Mul<B, C>> / Div<C, Mul<A, B>> -> Div<Mul<Mul<A, A>, A>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRightAsNumeratorAndMultiplyingDenominatorWithNumeratorRootAsLeftAndDenominatorLeftAsRight(
