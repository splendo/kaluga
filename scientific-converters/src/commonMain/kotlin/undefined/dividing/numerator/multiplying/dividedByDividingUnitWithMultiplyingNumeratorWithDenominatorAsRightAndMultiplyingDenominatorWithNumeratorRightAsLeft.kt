...
// Div<Mul<A, B>, C> / Div<Mul<D, C>, Mul<B, E>> -> Div<Mul<Mul<A, B>, Mul<B, E>>, Mul<Mul<C, D>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsRightAndMultiplyingDenominatorWithNumeratorRightAsLeft(
