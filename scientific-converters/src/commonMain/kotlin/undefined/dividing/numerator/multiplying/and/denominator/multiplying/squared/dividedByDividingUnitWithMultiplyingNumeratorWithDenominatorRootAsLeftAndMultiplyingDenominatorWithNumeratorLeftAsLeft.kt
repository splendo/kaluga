...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, D>, Mul<A, E>> -> Div<Mul<Mul<A, B>, Mul<A, E>>, Mul<Mul<C, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
