...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, E>, B> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, D>, Mul<C, E>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndNumeratorRightAsDenominator(
