...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, E>, C> -> Div<Mul<A, B>, Mul<Mul<D, D>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndDenominatorLeftAsDenominator(
