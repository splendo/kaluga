...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<B, D>, A> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, C>, Mul<B, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndNumeratorRootAsDenominator(
