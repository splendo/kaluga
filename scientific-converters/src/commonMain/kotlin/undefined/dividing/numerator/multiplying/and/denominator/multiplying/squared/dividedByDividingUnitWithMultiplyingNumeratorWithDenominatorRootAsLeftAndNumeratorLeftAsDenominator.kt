...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, D>, A> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<C, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndNumeratorLeftAsDenominator(
