...
// Div<Mul<A, B>, Mul<D, C>> / Div<Mul<D, B>, Mul<E, A>> -> Div<Mul<Mul<A, E>, A>, Mul<Mul<D, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndNumeratorRightAsRightAndMultiplyingDenominatorWithNumeratorLeftAsRight(
