...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, D>, Mul<E, A>> -> Div<Mul<Mul<A, B>, Mul<E, A>>, Mul<Mul<C, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndMultiplyingDenominatorWithNumeratorLeftAsRight(
