...
// Div<Mul<A, B>, C> / Div<Mul<D, C>, B> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, D>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsRightAndNumeratorRightAsDenominator(
