...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, A>, Mul<B, E>> -> Div<Mul<Mul<B, B>, E>, Mul<Mul<C, D>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndNumeratorLeftAsRightAndMultiplyingDenominatorWithNumeratorRightAsLeft(
