...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, D>, Mul<F, A>> -> Div<Mul<Mul<A, B>, Mul<F, A>>, Mul<Mul<C, D>, Mul<E, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsRightAndMultiplyingDenominatorWithNumeratorLeftAsRight(
