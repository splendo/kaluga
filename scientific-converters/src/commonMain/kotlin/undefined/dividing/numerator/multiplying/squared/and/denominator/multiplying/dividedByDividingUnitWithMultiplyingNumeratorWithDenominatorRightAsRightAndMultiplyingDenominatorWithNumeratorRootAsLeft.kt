...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<D, C>, Mul<A, E>> -> Div<Mul<Mul<A, A>, Mul<A, E>>, Mul<Mul<B, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsRightAndMultiplyingDenominatorWithNumeratorRootAsLeft(
