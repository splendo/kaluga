...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<B, C>, A> -> Div<Mul<A, A>, Mul<Mul<C, D>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorRightAsLeftAndDenominatorLeftAsRightAndNumeratorLeftAsDenominator(
