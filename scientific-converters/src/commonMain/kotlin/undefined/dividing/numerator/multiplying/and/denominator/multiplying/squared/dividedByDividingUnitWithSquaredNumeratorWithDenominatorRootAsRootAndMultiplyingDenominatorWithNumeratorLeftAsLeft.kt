...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, C>, Mul<A, D>> -> Div<Mul<Mul<A, B>, Mul<A, D>>, Mul<Mul<C, C>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRootAsRootAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
