...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, C>, Mul<B, D>> -> Div<Mul<Mul<A, B>, Mul<B, D>>, Mul<Mul<C, C>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRootAsRootAndMultiplyingDenominatorWithNumeratorRightAsLeft(
