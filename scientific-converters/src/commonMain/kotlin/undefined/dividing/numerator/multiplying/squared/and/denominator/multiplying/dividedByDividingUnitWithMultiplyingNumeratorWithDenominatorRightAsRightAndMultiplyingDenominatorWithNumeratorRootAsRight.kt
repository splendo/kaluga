...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<D, C>, Mul<E, A>> -> Div<Mul<Mul<A, A>, Mul<E, A>>, Mul<Mul<B, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsRightAndMultiplyingDenominatorWithNumeratorRootAsRight(
