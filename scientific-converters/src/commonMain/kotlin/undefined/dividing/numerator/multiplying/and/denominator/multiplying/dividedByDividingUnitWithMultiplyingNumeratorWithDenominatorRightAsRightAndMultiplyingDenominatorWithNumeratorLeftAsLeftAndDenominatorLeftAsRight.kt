...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, D>, Mul<A, C>> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<D, E>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsRightAndMultiplyingDenominatorWithNumeratorLeftAsLeftAndDenominatorLeftAsRight(
