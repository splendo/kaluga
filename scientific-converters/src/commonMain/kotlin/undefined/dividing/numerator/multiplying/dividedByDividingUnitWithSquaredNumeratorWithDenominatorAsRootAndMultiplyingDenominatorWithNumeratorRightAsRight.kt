...
// Div<Mul<A, B>, C> / Div<Mul<C, C>, Mul<D, B>> -> Div<Mul<Mul<A, B>, Mul<D, B>>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorAsRootAndMultiplyingDenominatorWithNumeratorRightAsRight(
