...
// Div<Mul<A, A>, B> / Div<Mul<B, B>, A> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, B>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorAsRootAndNumeratorRootAsDenominator(
