...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, E>, Mul<C, A>> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<D, D>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndMultiplyingDenominatorWithDenominatorLeftAsLeftAndNumeratorLeftAsRight(
