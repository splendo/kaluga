...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, D>, Mul<A, F>> -> Div<Mul<Mul<A, B>, Mul<A, F>>, Mul<Mul<C, D>, Mul<E, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsRightAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
