...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, D>, Mul<A, A>> -> Div<Mul<Mul<A, B>, Mul<A, A>>, Mul<Mul<C, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndSquaredDenominatorWithNumeratorLeftAsRoot(
