...
// Div<Mul<A, B>, Mul<C, C>> / Div<C, Mul<D, A>> -> Div<Mul<Mul<A, B>, Mul<D, A>>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRootAsNumeratorAndMultiplyingDenominatorWithNumeratorLeftAsRight(
