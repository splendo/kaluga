...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, E>, Mul<B, D>> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, C>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndMultiplyingDenominatorWithNumeratorRightAsLeftAndDenominatorRightAsRight(
