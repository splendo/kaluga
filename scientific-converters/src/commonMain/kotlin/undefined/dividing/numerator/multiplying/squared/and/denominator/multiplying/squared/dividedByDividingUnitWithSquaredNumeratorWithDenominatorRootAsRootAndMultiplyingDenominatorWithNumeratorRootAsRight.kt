...
// Div<Mul<A, A>, Mul<B, B>> / Div<Mul<B, B>, Mul<C, A>> -> Div<Mul<Mul<A, A>, Mul<C, A>>, Mul<Mul<B, B>, Mul<B, B>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRootAsRootAndMultiplyingDenominatorWithNumeratorRootAsRight(
