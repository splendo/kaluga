...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, C>, Mul<B, A>> -> Div<Mul<Mul<A, B>, Mul<B, A>>, Mul<Mul<C, D>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorLeftAsRootAndMultiplyingDenominatorWithNumeratorRightAsLeftAndNumeratorLeftAsRight(
