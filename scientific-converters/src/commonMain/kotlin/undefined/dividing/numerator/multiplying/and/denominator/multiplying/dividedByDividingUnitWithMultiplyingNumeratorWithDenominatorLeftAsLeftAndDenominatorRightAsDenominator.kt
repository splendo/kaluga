...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, E>, D> -> Div<Mul<A, B>, Mul<Mul<C, C>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndDenominatorRightAsDenominator(
