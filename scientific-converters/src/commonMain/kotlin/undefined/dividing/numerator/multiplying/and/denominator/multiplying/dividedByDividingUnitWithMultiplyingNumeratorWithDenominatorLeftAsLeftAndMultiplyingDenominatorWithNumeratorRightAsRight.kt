...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, E>, Mul<F, B>> -> Div<Mul<Mul<A, B>, Mul<F, B>>, Mul<Mul<C, D>, Mul<C, E>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndMultiplyingDenominatorWithNumeratorRightAsRight(
