...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, C>, Mul<A, A>> -> Div<Mul<Mul<A, B>, Mul<A, A>>, Mul<Mul<C, C>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRootAsRootAndSquaredDenominatorWithNumeratorLeftAsRoot(
