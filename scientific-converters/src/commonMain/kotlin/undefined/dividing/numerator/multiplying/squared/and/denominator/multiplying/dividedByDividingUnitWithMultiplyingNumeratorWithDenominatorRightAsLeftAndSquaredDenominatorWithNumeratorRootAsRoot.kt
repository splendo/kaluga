...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<C, D>, Mul<A, A>> -> Div<Mul<Mul<A, A>, Mul<A, A>>, Mul<Mul<B, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndSquaredDenominatorWithNumeratorRootAsRoot(
