...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, E>, Mul<F, A>> -> Div<Mul<Mul<A, B>, Mul<F, A>>, Mul<Mul<C, D>, Mul<C, E>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndMultiplyingDenominatorWithNumeratorLeftAsRight(
