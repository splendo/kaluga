...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<D, B>, A> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, C>, Mul<D, B>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndNumeratorRootAsDenominator(
