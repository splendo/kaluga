...
// Div<Mul<A, B>, C> / Div<C, Mul<B, D>> -> Div<Mul<Mul<A, B>, Mul<B, D>>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorAsNumeratorAndMultiplyingDenominatorWithNumeratorRightAsLeft(
