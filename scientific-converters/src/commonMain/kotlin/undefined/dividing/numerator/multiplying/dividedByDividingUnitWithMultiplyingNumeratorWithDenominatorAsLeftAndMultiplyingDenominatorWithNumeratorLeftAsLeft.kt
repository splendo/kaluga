...
// Div<Mul<A, B>, C> / Div<Mul<C, D>, Mul<A, E>> -> Div<Mul<Mul<A, B>, Mul<A, E>>, Mul<Mul<C, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsLeftAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
