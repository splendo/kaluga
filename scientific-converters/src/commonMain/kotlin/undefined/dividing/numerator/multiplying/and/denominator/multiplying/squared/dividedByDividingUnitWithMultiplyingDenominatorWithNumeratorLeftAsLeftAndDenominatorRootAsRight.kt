...
// Div<Mul<A, B>, Mul<C, C>> / Div<D, Mul<A, C>> -> Div<Mul<Mul<A, B>, A>, Mul<C, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithNumeratorLeftAsLeftAndDenominatorRootAsRight(
