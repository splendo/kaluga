...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, C>, E> -> Div<Mul<Mul<A, B>, E>, Mul<Mul<C, D>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndDenominatorLeftAsRight(
