...
// Div<Mul<A, B>, C> / Div<Mul<A, C>, Mul<D, B>> -> Div<Mul<Mul<B, D>, B>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorLeftAsLeftAndDenominatorAsRightAndMultiplyingDenominatorWithNumeratorRightAsRight(
