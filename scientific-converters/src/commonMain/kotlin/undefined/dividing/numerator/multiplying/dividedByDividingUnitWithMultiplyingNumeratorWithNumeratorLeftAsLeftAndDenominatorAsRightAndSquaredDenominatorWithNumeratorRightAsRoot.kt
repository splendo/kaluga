...
// Div<Mul<A, B>, C> / Div<Mul<A, C>, Mul<B, B>> -> Div<Mul<Mul<B, B>, B>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorLeftAsLeftAndDenominatorAsRightAndSquaredDenominatorWithNumeratorRightAsRoot(
