...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<A, E>, Mul<F, B>> -> Div<Mul<Mul<B, F>, B>, Mul<Mul<C, D>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorLeftAsLeftAndMultiplyingDenominatorWithNumeratorRightAsRight(
