...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<C, C>, A> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, C>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRightAsRootAndNumeratorRootAsDenominator(
