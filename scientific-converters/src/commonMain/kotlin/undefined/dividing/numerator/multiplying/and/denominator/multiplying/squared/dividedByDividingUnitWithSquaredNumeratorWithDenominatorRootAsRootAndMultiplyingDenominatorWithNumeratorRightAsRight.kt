...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, C>, Mul<D, B>> -> Div<Mul<Mul<A, B>, Mul<D, B>>, Mul<Mul<C, C>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRootAsRootAndMultiplyingDenominatorWithNumeratorRightAsRight(
