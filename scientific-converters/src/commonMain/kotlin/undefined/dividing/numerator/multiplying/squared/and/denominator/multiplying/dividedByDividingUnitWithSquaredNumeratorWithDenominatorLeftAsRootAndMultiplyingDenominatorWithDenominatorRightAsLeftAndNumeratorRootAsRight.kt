...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<B, B>, Mul<C, A>> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, B>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorLeftAsRootAndMultiplyingDenominatorWithDenominatorRightAsLeftAndNumeratorRootAsRight(
