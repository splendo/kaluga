...
// Div<Mul<A, B>, Mul<C, D>> / Div<E, Mul<C, A>> -> Div<Mul<Mul<A, B>, A>, Mul<D, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithDenominatorLeftAsLeftAndNumeratorLeftAsRight(
