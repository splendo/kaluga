...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, E>, B> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, D>, Mul<D, E>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndNumeratorRightAsDenominator(
