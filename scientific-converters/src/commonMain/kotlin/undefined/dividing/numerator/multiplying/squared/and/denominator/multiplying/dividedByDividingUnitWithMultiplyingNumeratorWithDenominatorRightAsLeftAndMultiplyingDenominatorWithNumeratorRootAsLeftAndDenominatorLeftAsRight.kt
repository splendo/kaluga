...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<C, D>, Mul<A, B>> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<C, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndMultiplyingDenominatorWithNumeratorRootAsLeftAndDenominatorLeftAsRight(
