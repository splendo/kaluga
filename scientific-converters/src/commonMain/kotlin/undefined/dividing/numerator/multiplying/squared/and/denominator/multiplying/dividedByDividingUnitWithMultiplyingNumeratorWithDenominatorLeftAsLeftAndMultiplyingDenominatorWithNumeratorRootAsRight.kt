...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<B, D>, Mul<E, A>> -> Div<Mul<Mul<A, A>, Mul<E, A>>, Mul<Mul<B, C>, Mul<B, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndMultiplyingDenominatorWithNumeratorRootAsRight(
