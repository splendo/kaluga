...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, C>, A> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<C, D>, Mul<E, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndNumeratorLeftAsDenominator(
