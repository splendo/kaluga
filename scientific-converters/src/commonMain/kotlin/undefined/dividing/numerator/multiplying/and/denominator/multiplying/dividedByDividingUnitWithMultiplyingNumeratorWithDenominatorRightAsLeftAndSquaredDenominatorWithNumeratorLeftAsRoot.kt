...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, E>, Mul<A, A>> -> Div<Mul<Mul<A, B>, Mul<A, A>>, Mul<Mul<C, D>, Mul<D, E>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndSquaredDenominatorWithNumeratorLeftAsRoot(
