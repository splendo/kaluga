...
// Div<Mul<A, B>, Mul<D, C>> / Div<Mul<D, A>, E> -> Div<Mul<B, E>, Mul<Mul<D, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndNumeratorLeftAsRight(
