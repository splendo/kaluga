...
// Div<Mul<A, A>, Mul<B, B>> / Div<C, Mul<B, A>> -> Div<Mul<Mul<A, A>, A>, Mul<B, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithDenominatorRootAsLeftAndNumeratorRootAsRight(
