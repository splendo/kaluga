...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<A, E>, Mul<B, F>> -> Div<Mul<Mul<B, B>, F>, Mul<Mul<C, D>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorLeftAsLeftAndMultiplyingDenominatorWithNumeratorRightAsLeft(
