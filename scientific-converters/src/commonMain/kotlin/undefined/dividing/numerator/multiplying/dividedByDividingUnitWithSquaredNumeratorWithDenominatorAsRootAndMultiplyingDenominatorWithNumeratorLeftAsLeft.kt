...
// Div<Mul<A, B>, C> / Div<Mul<C, C>, Mul<A, D>> -> Div<Mul<Mul<A, B>, Mul<A, D>>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorAsRootAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
