...
// Div<A, Mul<B, B>> / Div<Mul<C, B>, Mul<D, A>> -> Div<Mul<Mul<A, D>, A>, Mul<Mul<B, B>, Mul<C, B>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsRightAndMultiplyingDenominatorWithNumeratorAsRight(
