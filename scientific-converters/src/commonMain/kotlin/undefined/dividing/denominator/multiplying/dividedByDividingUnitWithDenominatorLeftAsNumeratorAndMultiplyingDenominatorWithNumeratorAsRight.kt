...
// Div<A, Mul<C, B>> / Div<C, Mul<D, A>> -> Div<Mul<Mul<A, D>, A>, Mul<Mul<C, B>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorLeftAsNumeratorAndMultiplyingDenominatorWithNumeratorAsRight(
