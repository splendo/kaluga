...
// Div<A, Mul<B, C>> / Div<C, Mul<A, A>> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRightAsNumeratorAndSquaredDenominatorWithNumeratorAsRoot(
