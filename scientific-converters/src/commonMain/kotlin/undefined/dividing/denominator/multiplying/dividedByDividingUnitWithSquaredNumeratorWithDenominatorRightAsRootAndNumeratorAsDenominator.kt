...
// Div<A, Mul<B, C>> / Div<Mul<C, C>, A> -> Div<Mul<A, A>, Mul<Mul<B, C>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRightAsRootAndNumeratorAsDenominator(
