...
// Div<A, Mul<B, C>> / Div<Mul<B, D>, A> -> Div<Mul<A, A>, Mul<Mul<B, C>, Mul<B, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndNumeratorAsDenominator(
