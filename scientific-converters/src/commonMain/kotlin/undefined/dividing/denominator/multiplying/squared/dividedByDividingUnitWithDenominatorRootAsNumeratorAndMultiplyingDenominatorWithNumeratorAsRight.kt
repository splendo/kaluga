...
// Div<A, Mul<B, B>> / Div<B, Mul<C, A>> -> Div<Mul<Mul<A, C>, A>, Mul<Mul<B, B>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRootAsNumeratorAndMultiplyingDenominatorWithNumeratorAsRight(
