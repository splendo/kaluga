...
// Div<A, Mul<B, C>> / Div<Mul<D, C>, Mul<A, A>> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsRightAndSquaredDenominatorWithNumeratorAsRoot(
