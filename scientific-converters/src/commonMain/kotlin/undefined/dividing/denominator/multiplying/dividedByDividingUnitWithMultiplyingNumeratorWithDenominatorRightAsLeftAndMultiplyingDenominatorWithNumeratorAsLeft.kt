...
// Div<A, Mul<B, C>> / Div<Mul<C, D>, Mul<A, E>> -> Div<Mul<Mul<A, A>, E>, Mul<Mul<B, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndMultiplyingDenominatorWithNumeratorAsLeft(
