 ...
 */
class MockCharacteristic(characteristic: CharacteristicWrapper, newActionFlow: MutableSharedFlow<in BaseDeviceConnectionManager.Event.AddAction>) : Characteristic(characteristic, newActionFlow = newActionFlow) {
