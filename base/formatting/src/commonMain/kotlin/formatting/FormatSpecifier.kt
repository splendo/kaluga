...
import com.splendo.kaluga.base.formatting.StringFormatter.Companion.getZero
...
import com.splendo.kaluga.base.i18n.upperCased
...
internal sealed class ParsingCharacter(val char: Char) {
    ...
    data class DateTime(val dateTime: com.splendo.kaluga.base.formatting.DateTime) : ParsingCharacter(dateTime.char)
