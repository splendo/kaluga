...
sealed class SciUnit {
    ...
    companion object {
        ...
        private val INCHES_IN_METER = 39.37007874.toDecimal()
        private val FEET_IN_METER = 3.280839895.toDecimal()
        private val YARDS_IN_METER = 1.0936132983.toDecimal()
        private val MILES_IN_METER = 0.0006213712.toDecimal()
         ...
         */
        private fun fromBaseSi(value: Decimal, toUnit: SciUnit): Decimal {
            return when (toUnit) {
                Length.Millimeters -> value * MILLIMETERS_IN_METER
                Length.Centimeters -> value * CENTIMETERS_IN_METER
                Length.Meters -> value
