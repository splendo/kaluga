...
fun <T0, T1, T2, T3, R> ((T0, T1, T2, T3) -> R).mock(
...
fun <T0, T1, T2, T3, R> (suspend (T0, T1, T2, T3) -> R).mock(
...
fun <T0, T1, T2, T3, R> (suspend (T0, T1, T2, T3) -> R).mock(defaultValue: R) = asSuspendedMock().also {
    it.on(
        ParameterMatcher.any<T0>(),
        ParameterMatcher.any<T1>(),
        ParameterMatcher.any<T2>(),
...
fun <T0, T1, T2, T3> (suspend (T0, T1, T2, T3) -> CharRange).mock() =
    mock(CharRange.Companion.EMPTY)
