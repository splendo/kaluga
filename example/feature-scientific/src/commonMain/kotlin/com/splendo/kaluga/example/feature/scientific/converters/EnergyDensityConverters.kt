...
val PhysicalQuantity.EnergyDensity.converters get() = listOf<QuantityConverter<PhysicalQuantity.EnergyDensity, *>>(
    SingleQuantityConverter("Pressure") { value, unit ->
        when (unit) {
            is EnergyDensity -> DefaultScientificValue(value, unit).asPressure()
