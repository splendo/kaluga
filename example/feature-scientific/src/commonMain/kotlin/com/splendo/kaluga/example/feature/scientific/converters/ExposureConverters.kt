...
val PhysicalQuantity.Exposure.converters get() = listOf<QuantityConverter<PhysicalQuantity.Exposure, *>>(
    QuantityConverterWithOperator(
        "Electric Charge from Weight",
        QuantityConverter.WithOperator.Type.Multiplication,
        PhysicalQuantity.Weight,
    ) { (leftValue, leftUnit), (rightValue, rightUnit) ->
        when {
            leftUnit is Exposure && rightUnit is Weight -> {
