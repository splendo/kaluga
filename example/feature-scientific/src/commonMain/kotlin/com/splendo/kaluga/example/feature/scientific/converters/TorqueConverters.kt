...
val PhysicalQuantity.Torque.converters get() = listOf<QuantityConverter<PhysicalQuantity.Torque, *>>(
    SingleQuantityConverter("Energy") { value, unit ->
        when (unit) {
            is Torque -> DefaultScientificValue(value, unit).asEnergy()
