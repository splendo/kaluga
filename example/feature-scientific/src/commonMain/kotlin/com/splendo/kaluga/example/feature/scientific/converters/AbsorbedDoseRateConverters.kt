...
val PhysicalQuantity.AbsorbedDoseRate.converters get() = listOf<QuantityConverter<PhysicalQuantity.AbsorbedDoseRate, *>>(
    QuantityConverterWithOperator(
        "Ionizing Radiation Absorbed Dose from Time",
        QuantityConverter.WithOperator.Type.Multiplication,
        PhysicalQuantity.Time,
    ) { (leftValue, leftUnit), (rightValue, rightUnit) ->
        when {
            leftUnit is AbsorbedDoseRate && rightUnit is Time -> {
