...
val PhysicalQuantity.CatalyticConcentration.converters get() = listOf<QuantityConverter<PhysicalQuantity.CatalyticConcentration, *>>(
    QuantityConverterWithOperator(
        "Catalystic Activity from Volume",
        QuantityConverter.WithOperator.Type.Multiplication,
        PhysicalQuantity.Volume,
    ) { (leftValue, leftUnit), (rightValue, rightUnit) ->
        when {
            leftUnit is CatalyticConcentration && rightUnit is Volume -> {
