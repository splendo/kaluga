...
val PhysicalQuantity.ThermalConductivity.converters get() = listOf<QuantityConverter<PhysicalQuantity.ThermalConductivity, *>>(
    QuantityConverterWithOperator(
        "Thermal Conductance from Length",
        QuantityConverter.WithOperator.Type.Multiplication,
        PhysicalQuantity.Length,
    ) { (leftValue, leftUnit), (rightValue, rightUnit) ->
        when {
            leftUnit is ThermalConductivity && rightUnit is Length -> {
