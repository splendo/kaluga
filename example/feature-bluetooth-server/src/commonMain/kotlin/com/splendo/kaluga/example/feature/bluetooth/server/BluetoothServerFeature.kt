...
/** [BluetoothServerBuilder] is an `expect class` — its constructor differs per platform. */
...
val bluetoothServerFeatureModule: Module = module {
    single {
        newBluetoothServerBuilder { context ->
