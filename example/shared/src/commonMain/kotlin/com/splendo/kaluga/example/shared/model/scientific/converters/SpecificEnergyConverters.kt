...
val PhysicalQuantity.SpecificEnergy.converters get() = listOf<QuantityConverter<PhysicalQuantity.SpecificEnergy, *>>(
    ...
    QuantityConverterWithOperator(
        "Specific Heat Capacity from Temperature",
        QuantityConverter.WithOperator.Type.Division,
    ...
    QuantityConverterWithOperator(
        "Temperature from Specific Heat Capacity",
        QuantityConverter.WithOperator.Type.Division,
