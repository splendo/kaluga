...
val PhysicalQuantity.Action.converters get() = listOf<QuantityConverter<PhysicalQuantity.Action, *, *>>(
    QuantityConverter("Energy from Time", QuantityConverter.Type.Division, TimeUnits) { (actionValue, actionUnit), (timeValue, timeUnit) ->
        when {
    ...
    QuantityConverter("Time from Energy", QuantityConverter.Type.Division, EnergyUnits) { (actionValue, actionUnit), (energyValue, energyUnit) ->
        when {
