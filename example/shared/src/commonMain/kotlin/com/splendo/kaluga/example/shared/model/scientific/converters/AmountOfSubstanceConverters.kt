...
val PhysicalQuantity.AmountOfSubstance.converters get() = listOf<QuantityConverter<PhysicalQuantity.AmountOfSubstance, *, *>>(
    QuantityConverter("Energy from Molar Energy", QuantityConverter.Type.Multiplication, MolarEnergyUnits) { (amountOfSubstanceValue, amountOfSubstanceUnit), (molarEnergyValue, molarEnergyUnit) ->
        when {
    ...
    QuantityConverter("Molality from Weight", QuantityConverter.Type.Division, WeightUnits) { (amountOfSubstanceValue, amountOfSubstanceUnit), (weightValue, weightUnit) ->
        when {
    ...
    QuantityConverter("Molarity from Volume", QuantityConverter.Type.Division, VolumeUnits) { (amountOfSubstanceValue, amountOfSubstanceUnit), (volumeValue, volumeUnit) ->
        when {
    ...
    QuantityConverter("Radioactivity from Time", QuantityConverter.Type.Custom("with λ"), TimeUnits) { (amountOfSubstanceValue, amountOfSubstanceUnit), (timeValue, timeUnit) ->
        when {
    ...
    QuantityConverter("Time from Catalystic Activity", QuantityConverter.Type.Division, CatalysticActivityUnits) { (amountOfSubstanceValue, amountOfSubstanceUnit), (catalysticActivityValue, catalysticActivityUnit) ->
        when {
    ...
    QuantityConverter("Volume from Molarity", QuantityConverter.Type.Division, MolarityUnits) { (amountOfSubstanceValue, amountOfSubstanceUnit), (molarityValue, molarityUnit) ->
        when {
    ...
    QuantityConverter("Weight from Molality", QuantityConverter.Type.Division, MolalityUnits) { (amountOfSubstanceValue, amountOfSubstanceUnit), (molalityValue, molalityUnit) ->
        when {
