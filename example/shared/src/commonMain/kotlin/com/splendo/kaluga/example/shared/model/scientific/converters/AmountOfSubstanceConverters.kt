...
val PhysicalQuantity.AmountOfSubstance.converters get() = listOf<QuantityConverter<PhysicalQuantity.AmountOfSubstance, *>>(
    QuantityConverterWithOperator(
        "Energy from Molar Energy",
        QuantityConverter.WithOperator.Type.Multiplication,
        PhysicalQuantity.MolarEnergy,
    ) { (amountOfSubstanceValue, amountOfSubstanceUnit), (molarEnergyValue, molarEnergyUnit) ->
        when {
    ...
    QuantityConverterWithOperator(
        "Molality from Weight",
        QuantityConverter.WithOperator.Type.Division,
        PhysicalQuantity.Weight,
    ) { (amountOfSubstanceValue, amountOfSubstanceUnit), (weightValue, weightUnit) ->
        when {
    ...
    QuantityConverterWithOperator(
        "Molarity from Volume",
        QuantityConverter.WithOperator.Type.Division,
        PhysicalQuantity.Volume,
    ) { (amountOfSubstanceValue, amountOfSubstanceUnit), (volumeValue, volumeUnit) ->
        when {
    ...
    QuantityConverterWithOperator(
        ...
        QuantityConverter.WithOperator.Type.Custom("with λ"),
        PhysicalQuantity.Time,
    ) { (amountOfSubstanceValue, amountOfSubstanceUnit), (timeValue, timeUnit) ->
        when {
    ...
    QuantityConverterWithOperator(
        "Time from Catalystic Activity",
        QuantityConverter.WithOperator.Type.Division,
        PhysicalQuantity.CatalysticActivity,
    ) { (amountOfSubstanceValue, amountOfSubstanceUnit), (catalysticActivityValue, catalysticActivityUnit) ->
        when {
    ...
    ) { (amountOfSubstanceValue, amountOfSubstanceUnit), (molarityValue, molarityUnit) ->
        when {
    ...
    ) { (amountOfSubstanceValue, amountOfSubstanceUnit), (molalityValue, molalityUnit) ->
        when {
