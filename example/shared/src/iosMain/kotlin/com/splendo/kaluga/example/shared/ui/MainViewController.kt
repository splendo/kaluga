 ...
 */
fun MainViewController(onFeatureSelected: (Feature) -> Unit): UIViewController = ComposeUIViewController {
    AppRootScreen(features = Feature.entries, onFeatureSelected = onFeatureSelected)
}
