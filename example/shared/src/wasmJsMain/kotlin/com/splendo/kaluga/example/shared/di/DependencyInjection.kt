...
/**
 * Web (`wasmJs`) bootstrap. Loads [sharedFeaturesModule] — which on the web resolves to the feature
 * modules whose Kaluga libraries support `wasmJs`. Mobile-only and non-web features are not linked here.
 */
