...
Kaluga use [Gitflow](https://nvie.com/posts/a-successful-git-branching-model/).
...
If you want to publish with a specific version string, you can override this value in `local.properties` (this file is already generated by your IDE normally), by setting `libraryVersion`:
