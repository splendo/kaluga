...
On Android the builder is an `ActivityLifecycleSubscribable` (see [lifecycle](../lifecycle)) that needs an `ActivityLifecycleSubscribable.LifecycleManager` object to provide the current context in which to display the review manager.
