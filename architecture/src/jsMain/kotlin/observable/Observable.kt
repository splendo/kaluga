...
class FlowObservable<T>(private val flow: Flow<T>, coroutineScope: CoroutineScope, dispatchers: DefaultDispatcherProvider = DefaultDispatcherProvider()) : Observable<T>() {
...
class FlowSubject<T>(private val flowable: HotFlowable<T>, private val coroutineScope: CoroutineScope, private val dispatchers: DefaultDispatcherProvider = DefaultDispatcherProvider()) : Subject<T>() {
