...
@JvmName("permittivityTimesLength")
infix operator fun <PermittivityUnit : Permittivity, LengthUnit : Length> ScientificValue<PhysicalQuantity.Permittivity, PermittivityUnit>.times(
    length: ScientificValue<PhysicalQuantity.Length, LengthUnit>,
) = unit.capacitance.capacitance(this, length)
