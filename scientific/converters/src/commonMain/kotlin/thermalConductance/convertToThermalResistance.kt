...
@JvmName("thermalConductanceThermalResistance")
fun <ConductanceUnit : ThermalConductance> ScientificValue<PhysicalQuantity.ThermalConductance, ConductanceUnit>.thermalResistance() =
    MetricAndUKImperialThermalResistance(Kelvin, Watt).thermalResistance(this)
