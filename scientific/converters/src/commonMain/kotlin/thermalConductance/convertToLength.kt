...
@JvmName("thermalConductanceDivThermalConductivity")
infix operator fun <ConductanceUnit : ThermalConductance, ConductivityUnit : ThermalConductivity> ScientificValue<PhysicalQuantity.ThermalConductance, ConductanceUnit>.div(
    thermalConductivity: ScientificValue<PhysicalQuantity.ThermalConductivity, ConductivityUnit>,
) = thermalConductivity.unit.per.length(this, thermalConductivity)
