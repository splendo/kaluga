...
@JvmName("thermalConductanceFromInvertedThermalResistanceDefault")
fun <
...
) = thermalConductance(thermalResistance, ::DefaultScientificValue)

@JvmName("thermalConductanceFromInvertedThermalResistance")
fun <
    ConductanceUnit : ThermalConductance,
    ResistanceUnit : ThermalResistance,
...
) = byInverting(thermalResistance, factory)
