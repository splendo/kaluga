...
@JvmName("thermalConductanceTimesTemperature")
infix operator fun <ConductanceUnit : ThermalConductance, TemperatureUnit : Temperature> ScientificValue<PhysicalQuantity.ThermalConductance, ConductanceUnit>.times(
    temperature: ScientificValue<PhysicalQuantity.Temperature, TemperatureUnit>,
) = unit.power.power(this, temperature)
