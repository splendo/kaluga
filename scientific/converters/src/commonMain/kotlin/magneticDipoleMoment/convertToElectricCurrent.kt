...
@JvmName("magneticDipoleMomentDivArea")
infix operator fun <MagneticDipoleMomentUnit : MagneticDipoleMoment, AreaUnit : Area> ScientificValue<PhysicalQuantity.MagneticDipoleMoment, MagneticDipoleMomentUnit>.div(
    area: ScientificValue<PhysicalQuantity.Area, AreaUnit>,
) = Ampere.current(this, area)
