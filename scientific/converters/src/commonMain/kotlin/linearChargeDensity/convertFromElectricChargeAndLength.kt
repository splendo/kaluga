...
@JvmName("linearChargeDensityFromElectricChargeAndLengthDefault")
fun <
...
) = linearChargeDensity(charge, length, ::DefaultScientificValue)

@JvmName("linearChargeDensityFromElectricChargeAndLength")
fun <
    ChargeUnit : ElectricCharge,
    LengthUnit : Length,
    LinearChargeDensityUnit : LinearChargeDensity,
    Value : ScientificValue<PhysicalQuantity.LinearChargeDensity, LinearChargeDensityUnit>,
    > LinearChargeDensityUnit.linearChargeDensity(
    charge: ScientificValue<PhysicalQuantity.ElectricCharge, ChargeUnit>,
    length: ScientificValue<PhysicalQuantity.Length, LengthUnit>,
    factory: (Decimal, LinearChargeDensityUnit) -> Value,
) = byDividing(charge, length, factory)
