...
@JvmName("massFlowRateFromMassFluxAndAreaDefault")
fun <
...
) = massFlowRate(massFlux, area, ::DefaultScientificValue)

@JvmName("massFlowRateFromMassFluxAndArea")
fun <
    MassFlowRateUnit : MassFlowRate,
    AreaUnit : Area,
    MassFluxUnit : MassFlux,
...
) = byMultiplying(massFlux, area, factory)
