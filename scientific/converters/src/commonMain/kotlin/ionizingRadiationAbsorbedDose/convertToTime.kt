...
@JvmName("absorbedDoseDivAbsorbedDoseRate")
infix operator fun <AbsorbedDoseUnit : IonizingRadiationAbsorbedDose> ScientificValue<PhysicalQuantity.IonizingRadiationAbsorbedDose, AbsorbedDoseUnit>.div(
    absorbedDoseRate: ScientificValue<PhysicalQuantity.AbsorbedDoseRate, AbsorbedDoseRate>,
) = absorbedDoseRate.unit.per.time(this, absorbedDoseRate)
