...
@JvmName("absorbedDoseFromAbsorbedDoseRateAndTimeDefault")
fun <
...
) = absorbedDose(absorbedDoseRate, time, ::DefaultScientificValue)

@JvmName("absorbedDoseFromAbsorbedDoseRateAndTime")
fun <
    AbsorbedDoseUnit : IonizingRadiationAbsorbedDose,
    TimeUnit : Time,
...
) = byMultiplying(absorbedDoseRate, time, factory)
