...
@JvmName("areaFromMassFlowRateAndMassFluxDefault")
fun <
...
) = area(massFlowRate, massFlux, ::DefaultScientificValue)

@JvmName("areaFromMassFlowRateAndMassFlux")
fun <
    MassFlowRateUnit : MassFlowRate,
    AreaUnit : Area,
    MassFluxUnit : MassFlux,
...
) = byDividing(massFlowRate, massFlux, factory)
