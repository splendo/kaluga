...
@JvmName("areaTimesElectricCurrentDensity")
infix operator fun <AreaUnit : Area, ElectricCurrentDensityUnit : ElectricCurrentDensity> ScientificValue<PhysicalQuantity.Area, AreaUnit>.times(
    electricCurrentDensity: ScientificValue<PhysicalQuantity.ElectricCurrentDensity, ElectricCurrentDensityUnit>,
) = electricCurrentDensity.unit.current.current(electricCurrentDensity, this)
