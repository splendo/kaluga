...
@JvmName("areaTimesSurfaceChargeDensity")
infix operator fun <AreaUnit : Area, SurfaceChargeDensityUnit : SurfaceChargeDensity> ScientificValue<PhysicalQuantity.Area, AreaUnit>.times(
    surfaceChargeDensity: ScientificValue<PhysicalQuantity.SurfaceChargeDensity, SurfaceChargeDensityUnit>,
) = surfaceChargeDensity.unit.charge.charge(surfaceChargeDensity, this)
