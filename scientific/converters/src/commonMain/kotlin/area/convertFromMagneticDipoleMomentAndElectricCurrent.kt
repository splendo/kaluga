...
@JvmName("areaFromMagneticDipoleMomentAndElectricCurrentDefault")
fun <
...
) = area(magneticDipoleMoment, current, ::DefaultScientificValue)

@JvmName("areaFromMagneticDipoleMomentAndElectricCurrent")
fun <
    CurrentUnit : ElectricCurrent,
    AreaUnit : Area,
    MagneticDipoleMomentUnit : MagneticDipoleMoment,
...
) = byDividing(magneticDipoleMoment, current, factory)
