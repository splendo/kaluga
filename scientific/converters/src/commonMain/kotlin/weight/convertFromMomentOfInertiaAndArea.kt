...
@JvmName("massFromMomentOfInertiaAndAreaDefault")
fun <
    WeightUnit : Weight,
    AreaUnit : Area,
...
) = mass(momentOfInertia, area, ::DefaultScientificValue)

@JvmName("massFromMomentOfInertiaAndArea")
fun <
    WeightUnit : Weight,
    AreaUnit : Area,
    MomentOfInertiaUnit : MomentOfInertia,
...
) = byDividing(momentOfInertia, area, factory)
