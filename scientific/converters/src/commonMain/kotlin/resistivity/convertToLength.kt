...
@JvmName("resistivityDivElectricResistance")
infix operator fun <ResistivityUnit : Resistivity, ResistanceUnit : ElectricResistance> ScientificValue<PhysicalQuantity.Resistivity, ResistivityUnit>.div(
    resistance: ScientificValue<PhysicalQuantity.ElectricResistance, ResistanceUnit>,
) = Meter.length(this, resistance)
