...
@JvmName("resistivityFromElectricResistanceAndLengthDefault")
fun <
...
) = resistivity(resistance, length, ::DefaultScientificValue)

@JvmName("resistivityFromElectricResistanceAndLength")
fun <
    ResistanceUnit : ElectricResistance,
    LengthUnit : Length,
    ResistivityUnit : Resistivity,
...
) = byMultiplying(resistance, length, factory)
