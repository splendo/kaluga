...
@JvmName("resistivityDivLength")
infix operator fun <ResistivityUnit : Resistivity, LengthUnit : Length> ScientificValue<PhysicalQuantity.Resistivity, ResistivityUnit>.div(
    length: ScientificValue<PhysicalQuantity.Length, LengthUnit>,
) = Ohm.resistance(this, length)
