...
@JvmName("capacitanceFromPermittivityAndLengthDefault")
fun <
...
) = capacitance(permittivity, length, ::DefaultScientificValue)

@JvmName("capacitanceFromPermittivityAndLength")
fun <
    CapacitanceUnit : ElectricCapacitance,
    LengthUnit : Length,
    PermittivityUnit : Permittivity,
...
) = byMultiplying(permittivity, length, factory)
