...
@JvmName("frequencyFromElectricCurrentDensityAndSurfaceChargeDensityDefault")
fun <
...
) = frequency(electricCurrentDensity, surfaceChargeDensity, ::DefaultScientificValue)

@JvmName("frequencyFromElectricCurrentDensityAndSurfaceChargeDensity")
fun <
    FrequencyUnit : Frequency,
    ElectricCurrentDensityUnit : ElectricCurrentDensity,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
...
) = byDividing(electricCurrentDensity, surfaceChargeDensity, factory)
