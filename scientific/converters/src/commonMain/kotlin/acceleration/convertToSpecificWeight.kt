...
@JvmName("accelerationTimesDensity")
infix operator fun <DensityUnit : Density, AccelerationUnit : Acceleration> ScientificValue<PhysicalQuantity.Acceleration, AccelerationUnit>.times(
