...
@JvmName("surfaceChargeDensityFromElectricCurrentDensityAndTimeDefault")
fun <
...
) = surfaceChargeDensity(electricCurrentDensity, time, ::DefaultScientificValue)

@JvmName("surfaceChargeDensityFromElectricCurrentDensityAndTime")
fun <
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
    ElectricCurrentDensityUnit : ElectricCurrentDensity,
    TimeUnit : Time,
...
) = byMultiplying(electricCurrentDensity, time, factory)
