...
@JvmName("surfaceChargeDensityFromMagneticFieldStrengthAndSpeedDefault")
fun <
...
) = surfaceChargeDensity(magneticFieldStrength, speed, ::DefaultScientificValue)

@JvmName("surfaceChargeDensityFromMagneticFieldStrengthAndSpeed")
fun <
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
    MagneticFieldStrengthUnit : MagneticFieldStrength,
    SpeedUnit : Speed,
...
) = byDividing(magneticFieldStrength, speed, factory)
