...
@JvmName("surfaceChargeDensityFromElectricChargeAndAreaDefault")
fun <
...
) = surfaceChargeDensity(charge, area, ::DefaultScientificValue)

@JvmName("surfaceChargeDensityFromElectricChargeAndArea")
fun <
    ChargeUnit : ElectricCharge,
    AreaUnit : Area,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
...
) = byDividing(charge, area, factory)
