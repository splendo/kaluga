...
@JvmName("surfaceChargeDensityFromPermittivityAndElectricFieldStrengthDefault")
fun <
...
) = surfaceChargeDensity(permittivity, electricFieldStrength, ::DefaultScientificValue)

@JvmName("surfaceChargeDensityFromPermittivityAndElectricFieldStrength")
fun <
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
    PermittivityUnit : Permittivity,
    ElectricFieldStrengthUnit : ElectricFieldStrength,
...
) = byMultiplying(permittivity, electricFieldStrength, factory)
