...
@JvmName("speedFromElectricCurrentDensityAndElectricChargeDensityDefault")
fun <
    SpeedUnit : Speed,
...
) = speed(electricCurrentDensity, electricChargeDensity, ::DefaultScientificValue)

@JvmName("speedFromElectricCurrentDensityAndElectricChargeDensity")
fun <
    SpeedUnit : Speed,
    ElectricCurrentDensityUnit : ElectricCurrentDensity,
    ElectricChargeDensityUnit : ElectricChargeDensity,
...
) = byDividing(electricCurrentDensity, electricChargeDensity, factory)
