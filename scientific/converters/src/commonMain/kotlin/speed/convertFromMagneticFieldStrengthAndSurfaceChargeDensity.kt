...
@JvmName("speedFromMagneticFieldStrengthAndSurfaceChargeDensityDefault")
fun <
    SpeedUnit : Speed,
...
) = speed(magneticFieldStrength, surfaceChargeDensity, ::DefaultScientificValue)

@JvmName("speedFromMagneticFieldStrengthAndSurfaceChargeDensity")
fun <
    SpeedUnit : Speed,
    MagneticFieldStrengthUnit : MagneticFieldStrength,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
...
) = byDividing(magneticFieldStrength, surfaceChargeDensity, factory)
