...
@JvmName("electricChargeDensityFromElectricChargeAndVolumeDefault")
fun <
...
) = electricChargeDensity(charge, volume, ::DefaultScientificValue)

@JvmName("electricChargeDensityFromElectricChargeAndVolume")
fun <
    ChargeUnit : ElectricCharge,
    VolumeUnit : Volume,
    ElectricChargeDensityUnit : ElectricChargeDensity,
...
) = byDividing(charge, volume, factory)
