...
@JvmName("electricChargeDensityFromElectricCurrentDensityAndSpeedDefault")
fun <
...
) = electricChargeDensity(electricCurrentDensity, speed, ::DefaultScientificValue)

@JvmName("electricChargeDensityFromElectricCurrentDensityAndSpeed")
fun <
    ElectricChargeDensityUnit : ElectricChargeDensity,
    ElectricCurrentDensityUnit : ElectricCurrentDensity,
    SpeedUnit : Speed,
    Value : ScientificValue<PhysicalQuantity.ElectricChargeDensity, ElectricChargeDensityUnit>,
    > ElectricChargeDensityUnit.electricChargeDensity(
    electricCurrentDensity: ScientificValue<PhysicalQuantity.ElectricCurrentDensity, ElectricCurrentDensityUnit>,
    speed: ScientificValue<PhysicalQuantity.Speed, SpeedUnit>,
    factory: (Decimal, ElectricChargeDensityUnit) -> Value,
) = byDividing(electricCurrentDensity, speed, factory)
