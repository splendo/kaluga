...
@JvmName("electricChargeDensityFromSurfaceChargeDensityAndLengthDefault")
fun <
...
) = electricChargeDensity(surfaceChargeDensity, length, ::DefaultScientificValue)

@JvmName("electricChargeDensityFromSurfaceChargeDensityAndLength")
fun <
    ElectricChargeDensityUnit : ElectricChargeDensity,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
    LengthUnit : Length,
...
) = byDividing(surfaceChargeDensity, length, factory)
