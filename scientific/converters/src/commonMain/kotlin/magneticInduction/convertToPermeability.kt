...
@JvmName("magneticInductionDivImperialMagneticFieldStrength")
infix operator fun <MagneticInductionUnit : MagneticInduction> ScientificValue<PhysicalQuantity.MagneticInduction, MagneticInductionUnit>.div(
    magneticFieldStrength: ScientificValue<PhysicalQuantity.MagneticFieldStrength, ImperialMagneticFieldStrength>,
) = (Henry per Foot).permeability(this, magneticFieldStrength)

@JvmName("magneticInductionDivMagneticFieldStrength")
infix operator fun <MagneticInductionUnit, MagneticFieldStrengthUnit> ScientificValue<PhysicalQuantity.MagneticInduction, MagneticInductionUnit>.div(
    magneticFieldStrength: ScientificValue<PhysicalQuantity.MagneticFieldStrength, MagneticFieldStrengthUnit>,
) where MagneticInductionUnit : MagneticInduction, MagneticFieldStrengthUnit : MagneticFieldStrength = (Henry per Meter).permeability(this, magneticFieldStrength)
