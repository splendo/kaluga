...
@JvmName("thermalResistanceThermalConductance")
fun <ResistanceUnit : ThermalResistance> ScientificValue<PhysicalQuantity.ThermalResistance, ResistanceUnit>.thermalConductance() =
    MetricAndUKImperialThermalConductance(Watt, Kelvin).thermalConductance(this)
