...
@JvmName("electricConductanceDivElectricalConductivity")
infix operator fun <ConductanceUnit, ElectricalConductivityUnit> ScientificValue<PhysicalQuantity.ElectricConductance, ConductanceUnit>.div(
    electricalConductivity: ScientificValue<PhysicalQuantity.ElectricalConductivity, ElectricalConductivityUnit>,
) where ConductanceUnit : ElectricConductance, ElectricalConductivityUnit : ElectricalConductivity = Meter.length(this, electricalConductivity)
