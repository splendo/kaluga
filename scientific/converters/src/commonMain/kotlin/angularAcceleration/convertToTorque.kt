...
@JvmName("angularAccelerationTimesMomentOfInertia")
infix operator fun <MomentOfInertiaUnit : MomentOfInertia> ScientificValue<PhysicalQuantity.AngularAcceleration, AngularAcceleration>.times(
    momentOfInertia: ScientificValue<PhysicalQuantity.MomentOfInertia, MomentOfInertiaUnit>,
) = momentOfInertia * this
