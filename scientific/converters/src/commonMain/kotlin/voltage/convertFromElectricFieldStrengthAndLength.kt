...
@JvmName("voltageFromElectricFieldStrengthAndLengthDefault")
fun <
    VoltageUnit : Voltage,
    LengthUnit : Length,
...
) = voltage(electricFieldStrength, length, ::DefaultScientificValue)

@JvmName("voltageFromElectricFieldStrengthAndLength")
fun <
    VoltageUnit : Voltage,
    LengthUnit : Length,
    ElectricFieldStrengthUnit : ElectricFieldStrength,
...
) = byMultiplying(electricFieldStrength, length, factory)
