...
@JvmName("temperatureFromPowerAndThermalConductanceDefault")
fun <
    TemperatureUnit : Temperature,
    PowerUnit : Power,
    ThermalConductanceUnit : ThermalConductance,
    > TemperatureUnit.temperature(
...
) = temperature(power, thermalConductance, ::DefaultScientificValue)

@JvmName("temperatureFromPowerAndThermalConductance")
fun <
    TemperatureUnit : Temperature,
    PowerUnit : Power,
    ThermalConductanceUnit : ThermalConductance,
...
) = deltaValue(Kelvin.byDividing(power, thermalConductance, ::DefaultScientificValue), factory)
