...
@JvmName("equivalentDoseDivEquivalentDoseRate")
infix operator fun <EquivalentDoseUnit : IonizingRadiationEquivalentDose> ScientificValue<PhysicalQuantity.IonizingRadiationEquivalentDose, EquivalentDoseUnit>.div(
    equivalentDoseRate: ScientificValue<PhysicalQuantity.EquivalentDoseRate, EquivalentDoseRate>,
) = equivalentDoseRate.unit.per.time(this, equivalentDoseRate)
