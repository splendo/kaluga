...
@JvmName("electricDipoleMomentDivElectricCharge")
infix operator fun <ElectricDipoleMomentUnit, ChargeUnit> ScientificValue<PhysicalQuantity.ElectricDipoleMoment, ElectricDipoleMomentUnit>.div(
    charge: ScientificValue<PhysicalQuantity.ElectricCharge, ChargeUnit>,
) where ElectricDipoleMomentUnit : ElectricDipoleMoment, ChargeUnit : ElectricCharge = Meter.length(this, charge)
