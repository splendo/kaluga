...
@JvmName("powerFromThermalConductanceAndTemperatureDefault")
fun <
    PowerUnit : Power,
...
) = power(thermalConductance, temperature, ::DefaultScientificValue)

@JvmName("powerFromThermalConductanceAndTemperature")
fun <
    PowerUnit : Power,
    TemperatureUnit : Temperature,
    ConductanceUnit : ThermalConductance,
...
) = byMultiplying(thermalConductance, Kelvin.deltaValue(temperature), factory)
