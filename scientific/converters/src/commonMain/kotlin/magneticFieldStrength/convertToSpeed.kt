...
infix operator fun <MagneticFieldStrengthUnit, SurfaceChargeDensityUnit> ScientificValue<PhysicalQuantity.MagneticFieldStrength, MagneticFieldStrengthUnit>.div(
    surfaceChargeDensity: ScientificValue<PhysicalQuantity.SurfaceChargeDensity, SurfaceChargeDensityUnit>,
) where MagneticFieldStrengthUnit : MagneticFieldStrength, SurfaceChargeDensityUnit : SurfaceChargeDensity = (Meter per Second).speed(this, surfaceChargeDensity)
