...
@JvmName("magneticFieldStrengthFromMagneticInductionAndPermeabilityDefault")
fun <
...
) = magneticFieldStrength(magneticInduction, permeability, ::DefaultScientificValue)

@JvmName("magneticFieldStrengthFromMagneticInductionAndPermeability")
fun <
    MagneticFieldStrengthUnit : MagneticFieldStrength,
    MagneticInductionUnit : MagneticInduction,
    PermeabilityUnit : Permeability,
...
) = byDividing(magneticInduction, permeability, factory)
