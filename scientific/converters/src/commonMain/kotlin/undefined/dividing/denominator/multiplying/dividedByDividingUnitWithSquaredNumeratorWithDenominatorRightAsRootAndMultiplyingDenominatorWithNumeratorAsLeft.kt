...
// Div<A, Mul<B, C>> / Div<Mul<C, C>, Mul<A, D>> -> Div<Mul<Mul<A, A>, D>, Mul<Mul<B, C>, Mul<C, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRightAsRootAndMultiplyingDenominatorWithNumeratorAsLeft(
