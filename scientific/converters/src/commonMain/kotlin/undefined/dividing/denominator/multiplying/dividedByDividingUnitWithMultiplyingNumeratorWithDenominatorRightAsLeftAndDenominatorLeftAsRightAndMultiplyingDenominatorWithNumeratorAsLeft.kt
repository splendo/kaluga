...
// Div<A, Mul<B, C>> / Div<Mul<C, B>, Mul<A, D>> -> Div<Mul<Mul<A, A>, D>, Mul<Mul<B, C>, Mul<C, B>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndDenominatorLeftAsRightAndMultiplyingDenominatorWithNumeratorAsLeft(
