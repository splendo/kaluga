...
// Div<A, Mul<B, C>> / Div<B, Mul<A, A>> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, C>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorLeftAsNumeratorAndSquaredDenominatorWithNumeratorAsRoot(
