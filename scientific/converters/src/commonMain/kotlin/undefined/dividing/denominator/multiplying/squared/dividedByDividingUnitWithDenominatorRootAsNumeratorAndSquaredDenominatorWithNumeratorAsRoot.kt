...
// Div<A, Mul<B, B>> / Div<B, Mul<A, A>> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, B>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRootAsNumeratorAndSquaredDenominatorWithNumeratorAsRoot(
