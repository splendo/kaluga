...
// Div<A, Mul<B, B>> / Div<Mul<B, C>, Mul<A, D>> -> Div<Mul<Mul<A, A>, D>, Mul<Mul<B, B>, Mul<B, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndMultiplyingDenominatorWithNumeratorAsLeft(
