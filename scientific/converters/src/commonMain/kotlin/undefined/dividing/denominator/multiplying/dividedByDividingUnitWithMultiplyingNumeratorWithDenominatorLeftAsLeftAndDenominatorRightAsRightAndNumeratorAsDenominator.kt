...
// Div<A, Mul<B, C>> / Div<Mul<B, C>, A> -> Div<Mul<A, A>, Mul<Mul<B, C>, Mul<B, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndDenominatorRightAsRightAndNumeratorAsDenominator(
