...
// Div<A, Mul<B, C>> / Div<Mul<D, C>, Mul<A, E>> -> Div<Mul<Mul<A, A>, E>, Mul<Mul<B, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsRightAndMultiplyingDenominatorWithNumeratorAsLeft(
