...
// Div<Mul<A, A>, Mul<B, B>> / Div<Mul<B, C>, Mul<A, D>> -> Div<Mul<Mul<A, A>, Mul<A, D>>, Mul<Mul<B, B>, Mul<B, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndMultiplyingDenominatorWithNumeratorRootAsLeft(
