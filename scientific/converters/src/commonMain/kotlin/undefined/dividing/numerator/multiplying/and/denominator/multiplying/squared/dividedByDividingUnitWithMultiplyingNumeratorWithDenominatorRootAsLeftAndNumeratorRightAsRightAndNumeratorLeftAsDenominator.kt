...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, B>, A> -> Div<Mul<A, A>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndNumeratorRightAsRightAndNumeratorLeftAsDenominator(
