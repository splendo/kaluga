...
// Div<Mul<A, B>, Mul<C, C>> / Div<D, Mul<C, A>> -> Div<Mul<Mul<A, B>, A>, Mul<C, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithDenominatorRootAsLeftAndNumeratorLeftAsRight(
