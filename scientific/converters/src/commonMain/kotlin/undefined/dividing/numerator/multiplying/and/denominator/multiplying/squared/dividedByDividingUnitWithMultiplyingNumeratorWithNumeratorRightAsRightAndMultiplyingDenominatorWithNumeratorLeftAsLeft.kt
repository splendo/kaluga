...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<D, B>, Mul<A, E>> -> Div<Mul<Mul<A, A>, E>, Mul<Mul<C, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorRightAsRightAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
