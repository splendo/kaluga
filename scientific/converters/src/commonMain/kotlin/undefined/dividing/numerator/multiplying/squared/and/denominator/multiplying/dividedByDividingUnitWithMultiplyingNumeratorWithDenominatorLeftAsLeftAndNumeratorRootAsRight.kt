...
// Div<Mul<A, A>, Mul<C, B>> / Div<Mul<C, A>, D> -> Div<Mul<A, D>, Mul<Mul<C, B>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndNumeratorRootAsRight(
