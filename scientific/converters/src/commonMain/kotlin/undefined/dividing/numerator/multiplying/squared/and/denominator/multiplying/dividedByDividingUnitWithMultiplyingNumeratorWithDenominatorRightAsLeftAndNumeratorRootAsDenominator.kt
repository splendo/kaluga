...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<C, D>, A> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndNumeratorRootAsDenominator(
