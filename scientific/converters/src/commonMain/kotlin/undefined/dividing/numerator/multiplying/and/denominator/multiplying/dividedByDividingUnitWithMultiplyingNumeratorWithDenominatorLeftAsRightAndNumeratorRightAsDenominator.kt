...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, C>, B> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, D>, Mul<E, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndNumeratorRightAsDenominator(
