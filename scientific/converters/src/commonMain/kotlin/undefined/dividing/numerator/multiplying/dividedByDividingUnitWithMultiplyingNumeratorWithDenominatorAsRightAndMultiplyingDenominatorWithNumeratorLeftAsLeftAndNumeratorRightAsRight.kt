...
// Div<Mul<A, B>, C> / Div<Mul<D, C>, Mul<A, B>> -> Div<Mul<Mul<A, B>, Mul<A, B>>, Mul<Mul<C, D>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsRightAndMultiplyingDenominatorWithNumeratorLeftAsLeftAndNumeratorRightAsRight(
