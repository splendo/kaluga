...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, E>, Mul<C, B>> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<D, D>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndMultiplyingDenominatorWithDenominatorLeftAsLeftAndNumeratorRightAsRight(
