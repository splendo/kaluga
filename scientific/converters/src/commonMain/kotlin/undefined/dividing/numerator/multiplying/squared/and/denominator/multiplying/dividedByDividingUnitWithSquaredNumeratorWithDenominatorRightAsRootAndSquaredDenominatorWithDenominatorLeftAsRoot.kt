...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<C, C>, Mul<B, B>> -> Div<Mul<Mul<A, A>, B>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRightAsRootAndSquaredDenominatorWithDenominatorLeftAsRoot(
