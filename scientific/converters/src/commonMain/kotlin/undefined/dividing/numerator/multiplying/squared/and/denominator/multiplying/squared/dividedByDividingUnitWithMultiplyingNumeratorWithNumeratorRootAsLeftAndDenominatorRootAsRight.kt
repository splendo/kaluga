...
// Div<Mul<A, A>, Mul<B, B>> / Div<Mul<A, B>, C> -> Div<Mul<A, C>, Mul<Mul<B, B>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorRootAsLeftAndDenominatorRootAsRight(
