...
// Div<Mul<A, A>, Mul<B, C>> / Div<D, Mul<A, B>> -> Div<Mul<Mul<A, A>, A>, Mul<C, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithNumeratorRootAsLeftAndDenominatorLeftAsRight(
