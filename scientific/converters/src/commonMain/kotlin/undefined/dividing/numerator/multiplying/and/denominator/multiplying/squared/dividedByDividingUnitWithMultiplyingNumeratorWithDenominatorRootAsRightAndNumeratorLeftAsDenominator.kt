...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<D, C>, A> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<C, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsRightAndNumeratorLeftAsDenominator(
