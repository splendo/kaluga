...
// Div<Mul<A, B>, Mul<C, D>> / Div<D, Mul<A, A>> -> Div<Mul<Mul<A, B>, Mul<A, A>>, Mul<Mul<C, D>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRightAsNumeratorAndSquaredDenominatorWithNumeratorLeftAsRoot(
