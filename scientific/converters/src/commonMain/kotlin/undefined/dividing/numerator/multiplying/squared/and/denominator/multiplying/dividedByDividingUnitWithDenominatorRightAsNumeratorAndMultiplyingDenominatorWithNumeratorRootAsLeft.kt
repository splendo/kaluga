...
// Div<Mul<A, A>, Mul<B, C>> / Div<C, Mul<A, D>> -> Div<Mul<Mul<A, A>, Mul<A, D>>, Mul<Mul<B, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRightAsNumeratorAndMultiplyingDenominatorWithNumeratorRootAsLeft(
