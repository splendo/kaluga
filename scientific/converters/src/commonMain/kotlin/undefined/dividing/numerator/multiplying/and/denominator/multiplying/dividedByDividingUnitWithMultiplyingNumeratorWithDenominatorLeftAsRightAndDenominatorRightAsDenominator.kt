...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, C>, D> -> Div<Mul<A, B>, Mul<Mul<C, E>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndDenominatorRightAsDenominator(
