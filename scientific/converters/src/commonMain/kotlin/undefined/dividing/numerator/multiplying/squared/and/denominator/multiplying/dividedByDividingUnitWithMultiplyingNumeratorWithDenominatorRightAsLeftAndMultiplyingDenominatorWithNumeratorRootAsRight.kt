...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<C, D>, Mul<E, A>> -> Div<Mul<Mul<A, A>, Mul<E, A>>, Mul<Mul<B, C>, Mul<C, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndMultiplyingDenominatorWithNumeratorRootAsRight(
