...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, C>, B> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, D>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndDenominatorLeftAsRightAndNumeratorRightAsDenominator(
