...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, D>, Mul<F, B>> -> Div<Mul<Mul<A, B>, Mul<F, B>>, Mul<Mul<C, D>, Mul<E, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsRightAndMultiplyingDenominatorWithNumeratorRightAsRight(
