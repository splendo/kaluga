...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<D, B>, Mul<C, A>> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, D>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndMultiplyingDenominatorWithDenominatorRightAsLeftAndNumeratorRootAsRight(
