...
// Div<Mul<A, B>, C> / Div<Mul<C, B>, Mul<A, D>> -> Div<Mul<Mul<A, A>, D>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsLeftAndNumeratorRightAsRightAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
