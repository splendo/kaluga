...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, E>, Mul<D, A>> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<C, C>, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndMultiplyingDenominatorWithDenominatorRightAsLeftAndNumeratorLeftAsRight(
