...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<D, B>, Mul<A, E>> -> Div<Mul<Mul<A, A>, Mul<A, E>>, Mul<Mul<B, C>, Mul<D, B>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndMultiplyingDenominatorWithNumeratorRootAsLeft(
