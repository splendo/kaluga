...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<E, C>, Mul<A, D>> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<C, E>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsRightAndMultiplyingDenominatorWithNumeratorLeftAsLeftAndDenominatorRightAsRight(
