...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<D, C>, B> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsRightAndNumeratorRightAsDenominator(
