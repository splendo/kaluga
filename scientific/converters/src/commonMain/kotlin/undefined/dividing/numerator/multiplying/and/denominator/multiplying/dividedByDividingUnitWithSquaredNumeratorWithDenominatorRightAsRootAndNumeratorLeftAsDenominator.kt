...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, D>, A> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<C, D>, Mul<D, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRightAsRootAndNumeratorLeftAsDenominator(
