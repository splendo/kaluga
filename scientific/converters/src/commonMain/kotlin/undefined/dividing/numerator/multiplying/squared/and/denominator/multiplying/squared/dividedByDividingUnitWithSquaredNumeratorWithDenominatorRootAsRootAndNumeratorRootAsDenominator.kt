...
// Div<Mul<A, A>, Mul<B, B>> / Div<Mul<B, B>, A> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, B>, Mul<B, B>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRootAsRootAndNumeratorRootAsDenominator(
