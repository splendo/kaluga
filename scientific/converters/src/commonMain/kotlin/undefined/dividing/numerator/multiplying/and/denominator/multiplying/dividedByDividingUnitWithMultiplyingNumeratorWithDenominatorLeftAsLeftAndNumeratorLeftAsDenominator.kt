...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, E>, A> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<C, D>, Mul<C, E>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndNumeratorLeftAsDenominator(
