...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<C, B>, Mul<A, A>> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsLeftAndNumeratorRightAsRightAndSquaredDenominatorWithNumeratorLeftAsRoot(
