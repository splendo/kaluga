...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, D>, Mul<A, B>> -> Div<Mul<Mul<A, B>, Mul<A, B>>, Mul<Mul<C, D>, Mul<D, D>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRightAsRootAndMultiplyingDenominatorWithNumeratorLeftAsLeftAndNumeratorRightAsRight(
