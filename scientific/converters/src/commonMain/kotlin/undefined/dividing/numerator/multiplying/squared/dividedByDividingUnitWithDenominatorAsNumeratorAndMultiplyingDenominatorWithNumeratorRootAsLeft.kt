...
// Div<Mul<A, A>, B> / Div<B, Mul<A, C>> -> Div<Mul<Mul<A, A>, Mul<A, C>>, Mul<B, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorAsNumeratorAndMultiplyingDenominatorWithNumeratorRootAsLeft(
