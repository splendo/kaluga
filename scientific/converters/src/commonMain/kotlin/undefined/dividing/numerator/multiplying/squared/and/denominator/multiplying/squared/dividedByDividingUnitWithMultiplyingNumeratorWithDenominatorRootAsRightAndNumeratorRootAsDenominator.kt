...
// Div<Mul<A, A>, Mul<B, B>> / Div<Mul<C, B>, A> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, B>, Mul<C, B>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsRightAndNumeratorRootAsDenominator(
