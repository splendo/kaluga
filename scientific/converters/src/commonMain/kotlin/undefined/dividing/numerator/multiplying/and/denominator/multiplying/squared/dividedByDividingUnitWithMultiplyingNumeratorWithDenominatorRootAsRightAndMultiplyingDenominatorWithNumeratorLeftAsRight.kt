...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<D, C>, Mul<E, A>> -> Div<Mul<Mul<A, B>, Mul<E, A>>, Mul<Mul<C, C>, Mul<D, C>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRootAsRightAndMultiplyingDenominatorWithNumeratorLeftAsRight(
