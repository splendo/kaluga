...
// Div<Mul<A, B>, C> / Div<C, Mul<A, D>> -> Div<Mul<Mul<A, B>, Mul<A, D>>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorAsNumeratorAndMultiplyingDenominatorWithNumeratorLeftAsLeft(
