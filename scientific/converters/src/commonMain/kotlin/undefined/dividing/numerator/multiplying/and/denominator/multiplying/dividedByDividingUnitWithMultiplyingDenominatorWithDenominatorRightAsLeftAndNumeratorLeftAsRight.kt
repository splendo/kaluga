...
// Div<Mul<A, B>, Mul<C, D>> / Div<E, Mul<D, A>> -> Div<Mul<Mul<A, B>, A>, Mul<C, E>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithDenominatorRightAsLeftAndNumeratorLeftAsRight(
