...
// Div<Mul<A, B>, Mul<C, D>> / Div<D, Mul<B, E>> -> Div<Mul<Mul<A, B>, Mul<B, E>>, Mul<Mul<C, D>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorRightAsNumeratorAndMultiplyingDenominatorWithNumeratorRightAsLeft(
