...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<C, C>, Mul<B, D>> -> Div<Mul<Mul<A, B>, B>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorLeftAsRootAndMultiplyingDenominatorWithNumeratorRightAsLeftAndDenominatorRightAsRight(
