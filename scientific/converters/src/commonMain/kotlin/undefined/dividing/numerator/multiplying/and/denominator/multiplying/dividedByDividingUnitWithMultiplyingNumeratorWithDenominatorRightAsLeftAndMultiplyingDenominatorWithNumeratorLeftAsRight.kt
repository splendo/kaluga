...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, E>, Mul<F, A>> -> Div<Mul<Mul<A, B>, Mul<F, A>>, Mul<Mul<C, D>, Mul<D, E>>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndMultiplyingDenominatorWithNumeratorLeftAsRight(
