...
// Div<Mul<A, B>, C> / Div<Mul<C, C>, A> -> Div<Mul<Mul<A, B>, A>, Mul<Mul<C, C>, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorAsRootAndNumeratorLeftAsDenominator(
