...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<B, D>, Mul<C, A>> -> Div<Mul<Mul<A, A>, A>, Mul<Mul<B, B>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorLeftAsLeftAndMultiplyingDenominatorWithDenominatorRightAsLeftAndNumeratorRootAsRight(
