...
// Div<Mul<A, B>, C> / Div<C, Mul<D, B>> -> Div<Mul<Mul<A, B>, Mul<D, B>>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorAsNumeratorAndMultiplyingDenominatorWithNumeratorRightAsRight(
