...
// Div<Mul<A, B>, Mul<C, D>> / Div<B, Mul<A, A>> -> Div<Mul<Mul<A, A>, A>, Mul<C, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithNumeratorRightAsNumeratorAndSquaredDenominatorWithNumeratorLeftAsRoot(
