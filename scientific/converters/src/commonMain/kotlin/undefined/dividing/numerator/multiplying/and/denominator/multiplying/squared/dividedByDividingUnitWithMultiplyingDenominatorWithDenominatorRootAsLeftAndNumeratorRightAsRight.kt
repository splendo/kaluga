...
// Div<Mul<A, B>, Mul<C, C>> / Div<D, Mul<C, B>> -> Div<Mul<Mul<A, B>, B>, Mul<C, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingDenominatorWithDenominatorRootAsLeftAndNumeratorRightAsRight(
