...
// Div<Mul<A, B>, Mul<C, C>> / Div<Mul<D, B>, Mul<E, A>> -> Div<Mul<Mul<A, E>, A>, Mul<Mul<C, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithNumeratorRightAsRightAndMultiplyingDenominatorWithNumeratorLeftAsRight(
