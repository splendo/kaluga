...
// Div<Mul<A, B>, Mul<C, D>> / Div<C, Mul<A, D>> -> Div<Mul<Mul<A, B>, A>, Mul<C, C>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithDenominatorLeftAsNumeratorAndMultiplyingDenominatorWithNumeratorLeftAsLeftAndDenominatorRightAsRight(
