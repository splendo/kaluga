...
// Div<Mul<A, B>, Mul<C, D>> / Div<Mul<D, D>, C> -> Div<Mul<A, B>, Mul<Mul<D, D>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithSquaredNumeratorWithDenominatorRightAsRootAndDenominatorLeftAsDenominator(
