...
// Div<Mul<A, A>, Mul<B, C>> / Div<Mul<C, D>, Mul<B, E>> -> Div<Mul<Mul<A, A>, E>, Mul<Mul<C, C>, D>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorRightAsLeftAndMultiplyingDenominatorWithDenominatorLeftAsLeft(
