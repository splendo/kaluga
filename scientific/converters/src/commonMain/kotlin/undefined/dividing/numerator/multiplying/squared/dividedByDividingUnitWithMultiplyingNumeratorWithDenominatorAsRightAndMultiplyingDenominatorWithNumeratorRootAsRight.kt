...
// Div<Mul<A, A>, B> / Div<Mul<C, B>, Mul<D, A>> -> Div<Mul<Mul<A, A>, Mul<D, A>>, Mul<Mul<B, C>, B>>
...
fun <
    ...
    UndefinedQuantityType.Dividing<
        ...
        >,
    NumeratorUnit,
    >.dividedByDividingUnitWithMultiplyingNumeratorWithDenominatorAsRightAndMultiplyingDenominatorWithNumeratorRootAsRight(
