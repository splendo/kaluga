...
@JvmName("lengthTimesThermalConductivity")
infix operator fun <ConductivityUnit : ThermalConductivity, LengthUnit : Length> ScientificValue<PhysicalQuantity.Length, LengthUnit>.times(
