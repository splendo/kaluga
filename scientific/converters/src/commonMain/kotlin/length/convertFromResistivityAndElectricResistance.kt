...
@JvmName("lengthFromResistivityAndElectricResistanceDefault")
fun <
...
) = length(resistivity, resistance, ::DefaultScientificValue)

@JvmName("lengthFromResistivityAndElectricResistance")
fun <
    ResistanceUnit : ElectricResistance,
    LengthUnit : Length,
    ResistivityUnit : Resistivity,
...
) = byDividing(resistivity, resistance, factory)
