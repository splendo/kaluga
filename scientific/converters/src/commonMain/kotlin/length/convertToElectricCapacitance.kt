...
@JvmName("lengthTimesPermittivity")
infix operator fun <LengthUnit : Length, PermittivityUnit : Permittivity> ScientificValue<PhysicalQuantity.Length, LengthUnit>.times(
    permittivity: ScientificValue<PhysicalQuantity.Permittivity, PermittivityUnit>,
) = permittivity.unit.capacitance.capacitance(permittivity, this)
