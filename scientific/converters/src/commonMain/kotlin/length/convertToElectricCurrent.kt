...
@JvmName("lengthTimesMagneticFieldStrength")
infix operator fun <LengthUnit : Length, MagneticFieldStrengthUnit : MagneticFieldStrength> ScientificValue<PhysicalQuantity.Length, LengthUnit>.times(
    magneticFieldStrength: ScientificValue<PhysicalQuantity.MagneticFieldStrength, MagneticFieldStrengthUnit>,
) = magneticFieldStrength.unit.current.current(magneticFieldStrength, this)
