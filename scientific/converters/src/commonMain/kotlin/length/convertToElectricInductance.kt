...
@JvmName("lengthTimesPermeability")
infix operator fun <LengthUnit : Length, PermeabilityUnit : Permeability> ScientificValue<PhysicalQuantity.Length, LengthUnit>.times(
    permeability: ScientificValue<PhysicalQuantity.Permeability, PermeabilityUnit>,
) = permeability.unit.inductance.inductance(permeability, this)
