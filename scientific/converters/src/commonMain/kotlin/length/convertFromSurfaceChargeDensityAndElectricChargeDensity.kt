...
@JvmName("lengthFromSurfaceChargeDensityAndElectricChargeDensityDefault")
fun <
    LengthUnit : Length,
...
) = length(surfaceChargeDensity, electricChargeDensity, ::DefaultScientificValue)

@JvmName("lengthFromSurfaceChargeDensityAndElectricChargeDensity")
fun <
    LengthUnit : Length,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
    ElectricChargeDensityUnit : ElectricChargeDensity,
...
) = byDividing(surfaceChargeDensity, electricChargeDensity, factory)
