...
@JvmName("lengthTimesElectricFieldStrength")
infix operator fun <LengthUnit : Length, ElectricFieldStrengthUnit : ElectricFieldStrength> ScientificValue<PhysicalQuantity.Length, LengthUnit>.times(
    electricFieldStrength: ScientificValue<PhysicalQuantity.ElectricFieldStrength, ElectricFieldStrengthUnit>,
) = electricFieldStrength.unit.voltage.voltage(electricFieldStrength, this)
