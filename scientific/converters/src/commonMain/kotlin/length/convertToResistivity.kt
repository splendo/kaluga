...
@JvmName("lengthTimesElectricResistance")
infix operator fun <ResistanceUnit : ElectricResistance, LengthUnit : Length> ScientificValue<PhysicalQuantity.Length, LengthUnit>.times(
