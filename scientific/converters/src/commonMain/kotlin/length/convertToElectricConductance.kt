...
@JvmName("lengthTimesElectricalConductivity")
infix operator fun <ElectricalConductivityUnit : ElectricalConductivity, LengthUnit : Length> ScientificValue<PhysicalQuantity.Length, LengthUnit>.times(
    electricalConductivity: ScientificValue<PhysicalQuantity.ElectricalConductivity, ElectricalConductivityUnit>,
) = electricalConductivity * this
