...
@JvmName("lengthTimesLinearChargeDensity")
infix operator fun <LinearChargeDensityUnit : LinearChargeDensity, LengthUnit : Length> ScientificValue<PhysicalQuantity.Length, LengthUnit>.times(
    linearChargeDensity: ScientificValue<PhysicalQuantity.LinearChargeDensity, LinearChargeDensityUnit>,
) = linearChargeDensity * this
