...
@JvmName("lengthTimesElectricCharge")
infix operator fun <ChargeUnit : ElectricCharge, LengthUnit : Length> ScientificValue<PhysicalQuantity.Length, LengthUnit>.times(
