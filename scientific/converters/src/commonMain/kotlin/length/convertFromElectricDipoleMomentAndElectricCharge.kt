...
@JvmName("lengthFromElectricDipoleMomentAndElectricChargeDefault")
fun <
    ChargeUnit : ElectricCharge,
    LengthUnit : Length,
    ElectricDipoleMomentUnit : ElectricDipoleMoment,
    > LengthUnit.length(
    electricDipoleMoment: ScientificValue<PhysicalQuantity.ElectricDipoleMoment, ElectricDipoleMomentUnit>,
    charge: ScientificValue<PhysicalQuantity.ElectricCharge, ChargeUnit>,
) = length(electricDipoleMoment, charge, ::DefaultScientificValue)

@JvmName("lengthFromElectricDipoleMomentAndElectricCharge")
fun <
    ChargeUnit : ElectricCharge,
    LengthUnit : Length,
    ElectricDipoleMomentUnit : ElectricDipoleMoment,
...
) = byDividing(electricDipoleMoment, charge, factory)
