...
@JvmName("electricalConductivityFromElectricConductanceAndLengthDefault")
fun <
...
) = electricalConductivity(conductance, length, ::DefaultScientificValue)

@JvmName("electricalConductivityFromElectricConductanceAndLength")
fun <
    ConductanceUnit : ElectricConductance,
    LengthUnit : Length,
    ElectricalConductivityUnit : ElectricalConductivity,
    Value : ScientificValue<PhysicalQuantity.ElectricalConductivity, ElectricalConductivityUnit>,
    > ElectricalConductivityUnit.electricalConductivity(
    conductance: ScientificValue<PhysicalQuantity.ElectricConductance, ConductanceUnit>,
    length: ScientificValue<PhysicalQuantity.Length, LengthUnit>,
    factory: (Decimal, ElectricalConductivityUnit) -> Value,
) = byDividing(conductance, length, factory)
