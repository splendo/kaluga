...
@JvmName("electricalConductivityResistivity")
fun <ConductivityUnit : ElectricalConductivity> ScientificValue<PhysicalQuantity.ElectricalConductivity, ConductivityUnit>.resistivity() = (Ohm x Meter).resistivity(this)
