...
@JvmName("amountOfSubstanceTimesMolarEntropy")
infix operator fun <MolarEntropyUnit : MolarEntropy, AmountOfSubstanceUnit : AmountOfSubstance> ScientificValue<PhysicalQuantity.AmountOfSubstance, AmountOfSubstanceUnit>.times(
