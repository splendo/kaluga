...
@JvmName("amountOfSubstanceFromHeatCapacityAndMolarEntropyDefault")
fun <
...
) = amountOfSubstance(heatCapacity, molarEntropy, ::DefaultScientificValue)

@JvmName("amountOfSubstanceFromHeatCapacityAndMolarEntropy")
fun <
    HeatCapacityUnit : HeatCapacity,
    AmountOfSubstanceUnit : AmountOfSubstance,
    MolarEntropyUnit : MolarEntropy,
...
) = byDividing(heatCapacity, molarEntropy, factory)
