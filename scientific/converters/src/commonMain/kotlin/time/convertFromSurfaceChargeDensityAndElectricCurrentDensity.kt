...
@JvmName("timeFromSurfaceChargeDensityAndElectricCurrentDensityDefault")
fun <
    TimeUnit : Time,
...
) = time(surfaceChargeDensity, electricCurrentDensity, ::DefaultScientificValue)

@JvmName("timeFromSurfaceChargeDensityAndElectricCurrentDensity")
fun <
    TimeUnit : Time,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
    ElectricCurrentDensityUnit : ElectricCurrentDensity,
...
) = byDividing(surfaceChargeDensity, electricCurrentDensity, factory)
