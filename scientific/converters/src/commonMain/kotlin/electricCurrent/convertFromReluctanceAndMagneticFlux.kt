...
@JvmName("electricCurrentFromReluctanceAndMagneticFluxDefault")
fun <
...
) = current(reluctance, flux, ::DefaultScientificValue)

@JvmName("electricCurrentFromReluctanceAndMagneticFlux")
fun <
    CurrentUnit : ElectricCurrent,
    FluxUnit : MagneticFlux,
...
) = byMultiplying(reluctance, flux, factory)
