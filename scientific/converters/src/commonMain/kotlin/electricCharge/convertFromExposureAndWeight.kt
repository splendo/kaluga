...
@JvmName("chargeFromExposureAndWeightDefault")
fun <
...
) = charge(exposure, weight, ::DefaultScientificValue)

@JvmName("chargeFromExposureAndWeight")
fun <
    ChargeUnit : ElectricCharge,
    WeightUnit : Weight,
    ExposureUnit : Exposure,
...
) = byMultiplying(exposure, weight, factory)
