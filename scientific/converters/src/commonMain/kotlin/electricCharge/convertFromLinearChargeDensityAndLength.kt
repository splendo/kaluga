...
@JvmName("electricChargeFromLinearChargeDensityAndLengthDefault")
fun <
...
) = charge(linearChargeDensity, length, ::DefaultScientificValue)

@JvmName("electricChargeFromLinearChargeDensityAndLength")
fun <
    ChargeUnit : ElectricCharge,
    LengthUnit : Length,
    LinearChargeDensityUnit : LinearChargeDensity,
...
) = byMultiplying(linearChargeDensity, length, factory)
