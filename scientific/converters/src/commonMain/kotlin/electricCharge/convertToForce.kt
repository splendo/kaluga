...
@JvmName("electricChargeTimesImperialElectricFieldStrength")
infix operator fun <ChargeUnit : ElectricCharge> ScientificValue<PhysicalQuantity.ElectricCharge, ChargeUnit>.times(
    electricFieldStrength: ScientificValue<PhysicalQuantity.ElectricFieldStrength, ImperialElectricFieldStrength>,
) = PoundForce.force(electricFieldStrength, this)

@JvmName("electricChargeTimesElectricFieldStrength")
infix operator fun <ChargeUnit, ElectricFieldStrengthUnit> ScientificValue<PhysicalQuantity.ElectricCharge, ChargeUnit>.times(
    electricFieldStrength: ScientificValue<PhysicalQuantity.ElectricFieldStrength, ElectricFieldStrengthUnit>,
) where ChargeUnit : ElectricCharge, ElectricFieldStrengthUnit : ElectricFieldStrength = Newton.force(electricFieldStrength, this)
