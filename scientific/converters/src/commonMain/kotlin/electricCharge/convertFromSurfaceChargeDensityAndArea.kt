...
@JvmName("chargeFromSurfaceChargeDensityAndAreaDefault")
fun <
...
) = charge(surfaceChargeDensity, area, ::DefaultScientificValue)

@JvmName("chargeFromSurfaceChargeDensityAndArea")
fun <
    ChargeUnit : ElectricCharge,
    AreaUnit : Area,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
...
) = byMultiplying(surfaceChargeDensity, area, factory)
