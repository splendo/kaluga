...
@JvmName("chargeFromElectricChargeDensityAndVolumeDefault")
fun <
...
) = charge(electricChargeDensity, volume, ::DefaultScientificValue)

@JvmName("chargeFromElectricChargeDensityAndVolume")
fun <
    ChargeUnit : ElectricCharge,
    VolumeUnit : Volume,
    ElectricChargeDensityUnit : ElectricChargeDensity,
...
) = byMultiplying(electricChargeDensity, volume, factory)
