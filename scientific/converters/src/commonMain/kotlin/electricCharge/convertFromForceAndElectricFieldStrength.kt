...
@JvmName("chargeFromForceAndElectricFieldStrengthDefault")
fun <
...
) = charge(force, electricFieldStrength, ::DefaultScientificValue)

@JvmName("chargeFromForceAndElectricFieldStrength")
fun <
    ChargeUnit : ElectricCharge,
    ForceUnit : Force,
    ElectricFieldStrengthUnit : ElectricFieldStrength,
...
) = byDividing(force, electricFieldStrength, factory)
