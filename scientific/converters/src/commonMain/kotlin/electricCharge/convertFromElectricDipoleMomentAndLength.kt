...
@JvmName("electricChargeFromElectricDipoleMomentAndLengthDefault")
fun <
...
) = charge(electricDipoleMoment, length, ::DefaultScientificValue)

@JvmName("electricChargeFromElectricDipoleMomentAndLength")
fun <
    ChargeUnit : ElectricCharge,
    LengthUnit : Length,
    ElectricDipoleMomentUnit : ElectricDipoleMoment,
...
) = byDividing(electricDipoleMoment, length, factory)
