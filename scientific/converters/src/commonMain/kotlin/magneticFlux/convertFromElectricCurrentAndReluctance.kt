...
@JvmName("magneticFluxFromElectricCurrentAndReluctanceDefault")
fun <
...
) = flux(current, reluctance, ::DefaultScientificValue)

@JvmName("magneticFluxFromElectricCurrentAndReluctance")
fun <
    CurrentUnit : ElectricCurrent,
    FluxUnit : MagneticFlux,
...
) = byDividing(current, reluctance, factory)
