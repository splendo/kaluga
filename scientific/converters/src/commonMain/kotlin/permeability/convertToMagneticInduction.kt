...
@JvmName("permeabilityTimesMagneticFieldStrength")
infix operator fun <PermeabilityUnit : Permeability, MagneticFieldStrengthUnit : MagneticFieldStrength> ScientificValue<PhysicalQuantity.Permeability, PermeabilityUnit>.times(
    magneticFieldStrength: ScientificValue<PhysicalQuantity.MagneticFieldStrength, MagneticFieldStrengthUnit>,
) = Tesla.induction(this, magneticFieldStrength)
