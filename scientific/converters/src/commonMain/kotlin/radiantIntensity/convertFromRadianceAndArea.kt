...
@JvmName("radiantIntensityFromRadianceAndAreaDefault")
fun <
...
) = radiantIntensity(radiance, area, ::DefaultScientificValue)

@JvmName("radiantIntensityFromRadianceAndArea")
fun <
    RadiantIntensityUnit : RadiantIntensity,
    AreaUnit : Area,
    RadianceUnit : Radiance,
...
) = byMultiplying(radiance, area, factory)
