...
infix operator fun <ElectricFieldStrengthUnit, PermittivityUnit> ScientificValue<PhysicalQuantity.ElectricFieldStrength, ElectricFieldStrengthUnit>.times(
    permittivity: ScientificValue<PhysicalQuantity.Permittivity, PermittivityUnit>,
) where ElectricFieldStrengthUnit : ElectricFieldStrength, PermittivityUnit : Permittivity = (Coulomb per SquareMeter).surfaceChargeDensity(permittivity, this)
