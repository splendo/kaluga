...
@JvmName("electricFieldStrengthFromSurfaceChargeDensityAndPermittivityDefault")
fun <
...
) = electricFieldStrength(surfaceChargeDensity, permittivity, ::DefaultScientificValue)

@JvmName("electricFieldStrengthFromSurfaceChargeDensityAndPermittivity")
fun <
    ElectricFieldStrengthUnit : ElectricFieldStrength,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
    PermittivityUnit : Permittivity,
    Value : ScientificValue<PhysicalQuantity.ElectricFieldStrength, ElectricFieldStrengthUnit>,
    > ElectricFieldStrengthUnit.electricFieldStrength(
    surfaceChargeDensity: ScientificValue<PhysicalQuantity.SurfaceChargeDensity, SurfaceChargeDensityUnit>,
    permittivity: ScientificValue<PhysicalQuantity.Permittivity, PermittivityUnit>,
    factory: (Decimal, ElectricFieldStrengthUnit) -> Value,
) = byDividing(surfaceChargeDensity, permittivity, factory)
