...
@JvmName("electricFieldStrengthFromVoltageAndLengthDefault")
fun <
    VoltageUnit : Voltage,
    LengthUnit : Length,
...
) = electricFieldStrength(voltage, length, ::DefaultScientificValue)

@JvmName("electricFieldStrengthFromVoltageAndLength")
fun <
    VoltageUnit : Voltage,
    LengthUnit : Length,
    ElectricFieldStrengthUnit : ElectricFieldStrength,
...
) = byDividing(voltage, length, factory)
