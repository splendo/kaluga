...
@JvmName("electricFieldStrengthFromForceAndElectricChargeDefault")
fun <
...
) = electricFieldStrength(force, charge, ::DefaultScientificValue)

@JvmName("electricFieldStrengthFromForceAndElectricCharge")
fun <
    ElectricFieldStrengthUnit : ElectricFieldStrength,
    ForceUnit : Force,
    ChargeUnit : ElectricCharge,
...
) = byDividing(force, charge, factory)
