...
@JvmName("forceDivElectricFieldStrength")
infix operator fun <ForceUnit : Force, ElectricFieldStrengthUnit : ElectricFieldStrength> ScientificValue<PhysicalQuantity.Force, ForceUnit>.div(
    electricFieldStrength: ScientificValue<PhysicalQuantity.ElectricFieldStrength, ElectricFieldStrengthUnit>,
) = Coulomb.charge(this, electricFieldStrength)
