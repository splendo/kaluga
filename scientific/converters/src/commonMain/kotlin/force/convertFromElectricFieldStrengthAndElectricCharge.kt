...
@JvmName("forceFromElectricFieldStrengthAndElectricChargeDefault")
fun <
    ForceUnit : Force,
...
) = force(electricFieldStrength, charge, ::DefaultScientificValue)

@JvmName("forceFromElectricFieldStrengthAndElectricCharge")
fun <
    ForceUnit : Force,
    ElectricFieldStrengthUnit : ElectricFieldStrength,
    ChargeUnit : ElectricCharge,
...
) = byMultiplying(electricFieldStrength, charge, factory)
