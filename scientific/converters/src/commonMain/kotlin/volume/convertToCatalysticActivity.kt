...
@JvmName("volumeTimesCatalyticConcentration")
infix operator fun <VolumeUnit : Volume, CatalyticConcentrationUnit : CatalyticConcentration> ScientificValue<PhysicalQuantity.Volume, VolumeUnit>.times(
    catalyticConcentration: ScientificValue<PhysicalQuantity.CatalyticConcentration, CatalyticConcentrationUnit>,
) = catalyticConcentration.unit.catalysticActivity.catalysticActivity(catalyticConcentration, this)
