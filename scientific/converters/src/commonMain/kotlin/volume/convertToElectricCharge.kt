...
@JvmName("volumeTimesElectricChargeDensity")
infix operator fun <VolumeUnit : Volume, ElectricChargeDensityUnit : ElectricChargeDensity> ScientificValue<PhysicalQuantity.Volume, VolumeUnit>.times(
    electricChargeDensity: ScientificValue<PhysicalQuantity.ElectricChargeDensity, ElectricChargeDensityUnit>,
) = electricChargeDensity.unit.charge.charge(electricChargeDensity, this)
