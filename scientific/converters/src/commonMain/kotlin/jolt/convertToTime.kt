...
@JvmName("joltDivSnap")
infix operator fun <JoltUnit : Jolt, SnapUnit : Snap> ScientificValue<PhysicalQuantity.Jolt, JoltUnit>.div(snap: ScientificValue<PhysicalQuantity.Snap, SnapUnit>) =
    snap.unit.per.time(this, snap)
