...
@JvmName("joltFromSnapAndTimeDefault")
fun <
    JoltUnit : Jolt,
    TimeUnit : Time,
    SnapUnit : Snap,
    > JoltUnit.jolt(
    snap: ScientificValue<PhysicalQuantity.Snap, SnapUnit>,
    time: ScientificValue<PhysicalQuantity.Time, TimeUnit>,
) = jolt(snap, time, ::DefaultScientificValue)

@JvmName("joltFromSnapAndTime")
fun <
    JoltUnit : Jolt,
    TimeUnit : Time,
    SnapUnit : Snap,
...
) = byMultiplying(snap, time, factory)
