...
@JvmName("electricCurrentDensityDivSurfaceChargeDensity")
infix operator fun <ElectricCurrentDensityUnit, SurfaceChargeDensityUnit> ScientificValue<PhysicalQuantity.ElectricCurrentDensity, ElectricCurrentDensityUnit>.div(
    surfaceChargeDensity: ScientificValue<PhysicalQuantity.SurfaceChargeDensity, SurfaceChargeDensityUnit>,
) where ElectricCurrentDensityUnit : ElectricCurrentDensity, SurfaceChargeDensityUnit : SurfaceChargeDensity = Hertz.frequency(this, surfaceChargeDensity)
