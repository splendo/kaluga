...
@JvmName("electricCurrentDensityFromElectricCurrentAndAreaDefault")
fun <
...
) = electricCurrentDensity(current, area, ::DefaultScientificValue)

@JvmName("electricCurrentDensityFromElectricCurrentAndArea")
fun <
    CurrentUnit : ElectricCurrent,
    AreaUnit : Area,
    ElectricCurrentDensityUnit : ElectricCurrentDensity,
...
) = byDividing(current, area, factory)
