...
@JvmName("electricCurrentDensityFromSurfaceChargeDensityAndTimeDefault")
fun <
...
) = electricCurrentDensity(surfaceChargeDensity, time, ::DefaultScientificValue)

@JvmName("electricCurrentDensityFromSurfaceChargeDensityAndTime")
fun <
    ElectricCurrentDensityUnit : ElectricCurrentDensity,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
    TimeUnit : Time,
...
) = byDividing(surfaceChargeDensity, time, factory)
