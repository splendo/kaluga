...
@JvmName("electricCurrentDensityTimesResistivity")
infix operator fun <CurrentDensityUnit : ElectricCurrentDensity, ResistivityUnit : Resistivity> ScientificValue<PhysicalQuantity.ElectricCurrentDensity, CurrentDensityUnit>.times(
