...
@JvmName("electricCurrentDensityFromMagneticFieldStrengthAndLengthDefault")
fun <
...
) = electricCurrentDensity(magneticFieldStrength, length, ::DefaultScientificValue)

@JvmName("electricCurrentDensityFromMagneticFieldStrengthAndLength")
fun <
    ElectricCurrentDensityUnit : ElectricCurrentDensity,
    MagneticFieldStrengthUnit : MagneticFieldStrength,
    LengthUnit : Length,
...
) = byDividing(magneticFieldStrength, length, factory)
