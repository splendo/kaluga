...
@JvmName("electricCurrentDensityFromSurfaceChargeDensityAndFrequencyDefault")
fun <
...
) = electricCurrentDensity(surfaceChargeDensity, frequency, ::DefaultScientificValue)

@JvmName("electricCurrentDensityFromSurfaceChargeDensityAndFrequency")
fun <
    ElectricCurrentDensityUnit : ElectricCurrentDensity,
    SurfaceChargeDensityUnit : SurfaceChargeDensity,
    FrequencyUnit : Frequency,
...
) = byMultiplying(surfaceChargeDensity, frequency, factory)
