...
import com.splendo.kaluga.scientific.length.height
...
operator fun ScientificValue<MeasurementType.Volume, CubicMegameter>.div(area: ScientificValue<MeasurementType.Area, SquareMegameter>) = Megameter.height(this, area)
@JvmName("cubicGigameterDivSquareGigameter")
operator fun ScientificValue<MeasurementType.Volume, CubicGigameter>.div(area: ScientificValue<MeasurementType.Area, SquareGigameter>) = Gigameter.height(this, area)
