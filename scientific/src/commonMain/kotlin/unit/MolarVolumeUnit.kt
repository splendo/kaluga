 ...
 */
@Serializable
data class MetricMolarVolume(override val volume: MetricVolume, override val per: AmountOfSubstance) :
    MolarVolume(),
    MetricScientificUnit<PhysicalQuantity.MolarVolume> {
 ...
 */
@Serializable
data class ImperialMolarVolume(override val volume: ImperialVolume, override val per: AmountOfSubstance) :
    MolarVolume(),
    ImperialScientificUnit<PhysicalQuantity.MolarVolume> {
 ...
 */
@Serializable
data class USCustomaryMolarVolume(override val volume: USCustomaryVolume, override val per: AmountOfSubstance) :
    MolarVolume(),
    USCustomaryScientificUnit<PhysicalQuantity.MolarVolume> {
 ...
 */
@Serializable
data class UKImperialMolarVolume(override val volume: UKImperialVolume, override val per: AmountOfSubstance) :
    MolarVolume(),
    UKImperialScientificUnit<PhysicalQuantity.MolarVolume> {
