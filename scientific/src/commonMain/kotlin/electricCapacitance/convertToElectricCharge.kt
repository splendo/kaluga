...
infix operator fun ScientificValue<MeasurementType.ElectricCapacitance, Abfarad>.times(voltage: ScientificValue<MeasurementType.Voltage, Abvolt>) = Abcoulomb.charge(this, voltage)
