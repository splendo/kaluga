...
infix operator fun <WeightUnit : Weight> ScientificValue<PhysicalQuantity.IonizingRadiationAbsorbedDose, Rad>.times(
    weight: ScientificValue<PhysicalQuantity.Weight, WeightUnit>
) = Erg.energy(this, weight)

@JvmName("radMultipleTimesWeight")
infix operator fun <AbsorbedDoseUnit, WeightUnit : Weight> ScientificValue<PhysicalQuantity.IonizingRadiationAbsorbedDose, AbsorbedDoseUnit>.times(
    weight: ScientificValue<PhysicalQuantity.Weight, WeightUnit>
