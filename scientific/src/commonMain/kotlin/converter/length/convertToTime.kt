...
infix operator fun <LengthUnit : Length, SpeedUnit : Speed> ScientificValue<PhysicalQuantity.Length, LengthUnit>.div(speed: ScientificValue<PhysicalQuantity.Speed, SpeedUnit>) =
