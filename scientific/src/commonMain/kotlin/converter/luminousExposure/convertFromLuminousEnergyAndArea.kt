...
@JvmName("luminousExposureFromLuminousEnergyAndAreaDefault")
fun <
...
) = luminousExposure(luminousEnergy, area, ::DefaultScientificValue)
...
) = byDividing(luminousEnergy, area, factory)
