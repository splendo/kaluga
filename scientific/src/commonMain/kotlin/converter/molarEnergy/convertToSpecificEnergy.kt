...
infix operator fun ScientificValue<MeasurementType.MolarEnergy, MetricMolarEnergy>.div(molarMass: ScientificValue<MeasurementType.MolarMass, MetricMolarMass>) =
    (unit.energy per molarMass.unit.weight).specificEnergy(this, molarMass)

@JvmName("imperialMolarEnergyDivImperialMolarMass")
infix operator fun ScientificValue<MeasurementType.MolarEnergy, ImperialMolarEnergy>.div(molarMass: ScientificValue<MeasurementType.MolarMass, ImperialMolarMass>) =
    (unit.energy per molarMass.unit.weight).specificEnergy(this, molarMass)

@JvmName("imperialMolarEnergyDivUKImperialMolarMass")
infix operator fun ScientificValue<MeasurementType.MolarEnergy, ImperialMolarEnergy>.div(molarMass: ScientificValue<MeasurementType.MolarMass, UKImperialMolarMass>) =
    (unit.energy per molarMass.unit.weight).specificEnergy(this, molarMass)

@JvmName("imperialMolarEnergyDivUSCustomaryMolarMass")
infix operator fun ScientificValue<MeasurementType.MolarEnergy, ImperialMolarEnergy>.div(molarMass: ScientificValue<MeasurementType.MolarMass, USCustomaryMolarMass>) =
    (unit.energy per molarMass.unit.weight).specificEnergy(this, molarMass)

@JvmName("molarEnergyDivMolarMass")
infix operator fun <MolarEnergyUnit : MolarEnergy, MolarMassUnit : MolarMass> ScientificValue<MeasurementType.MolarEnergy, MolarEnergyUnit>.div(
...
infix operator fun ScientificValue<MeasurementType.MolarEnergy, MetricAndImperialMolarEnergy>.times(
...
infix operator fun ScientificValue<MeasurementType.MolarEnergy, MetricMolarEnergy>.times(molality: ScientificValue<MeasurementType.Molality, MetricMolality>) =
    (unit.energy per molality.unit.per).specificEnergy(this, molality)

@JvmName("imperialMolarEnergyTimesImperialMolality")
infix operator fun ScientificValue<MeasurementType.MolarEnergy, ImperialMolarEnergy>.times(molality: ScientificValue<MeasurementType.Molality, ImperialMolality>) =
    (unit.energy per molality.unit.per).specificEnergy(this, molality)

@JvmName("imperialMolarEnergyTimesUKImperialMolality")
infix operator fun ScientificValue<MeasurementType.MolarEnergy, ImperialMolarEnergy>.times(molality: ScientificValue<MeasurementType.Molality, UKImperialMolality>) =
    (unit.energy per molality.unit.per).specificEnergy(this, molality)

@JvmName("imperialMolarEnergyTimesUSCustomaryMolality")
infix operator fun ScientificValue<MeasurementType.MolarEnergy, ImperialMolarEnergy>.times(molality: ScientificValue<MeasurementType.Molality, USCustomaryMolality>) =
    (unit.energy per molality.unit.per).specificEnergy(this, molality)

@JvmName("molarEnergyTimesMolality")
infix operator fun <MolarEnergyUnit : MolarEnergy, MolalityUnit : Molality> ScientificValue<MeasurementType.MolarEnergy, MolarEnergyUnit>.times(
