...
infix operator fun <EnergyUnit : Energy, TimeUnit : Time> ScientificValue<PhysicalQuantity.Time, TimeUnit>.times(energy: ScientificValue<PhysicalQuantity.Energy, EnergyUnit>) =
    energy * this
