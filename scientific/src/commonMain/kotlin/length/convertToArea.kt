...
operator fun ScientificValue<MeasurementType.Length, Meter>.times(width: ScientificValue<MeasurementType.Length, Meter>) = SquareMeter.area(this, width)
@JvmName("nanometerTimesNanometer")
operator fun ScientificValue<MeasurementType.Length, Nanometer>.times(width: ScientificValue<MeasurementType.Length, Nanometer>) = SquareNanometer.area(this, width)
@JvmName("micrometerTimesMicrometer")
operator fun ScientificValue<MeasurementType.Length, Micrometer>.times(width: ScientificValue<MeasurementType.Length, Micrometer>) = SquareMicrometer.area(this, width)
@JvmName("millimeterTimesMillimeter")
operator fun ScientificValue<MeasurementType.Length, Millimeter>.times(width: ScientificValue<MeasurementType.Length, Millimeter>) = SquareMillimeter.area(this, width)
@JvmName("centimeterTimesCentieter")
operator fun ScientificValue<MeasurementType.Length, Centimeter>.times(width: ScientificValue<MeasurementType.Length, Centimeter>) = SquareCentimeter.area(this, width)
@JvmName("decimeterTimesDecimeter")
operator fun ScientificValue<MeasurementType.Length, Decimeter>.times(width: ScientificValue<MeasurementType.Length, Decimeter>) = SquareDecimeter.area(this, width)
@JvmName("decameterTimesDecameter")
operator fun ScientificValue<MeasurementType.Length, Decameter>.times(width: ScientificValue<MeasurementType.Length, Decameter>) = SquareDecameter.area(this, width)
@JvmName("hectometerTimesHectometer")
operator fun ScientificValue<MeasurementType.Length, Hectometer>.times(width: ScientificValue<MeasurementType.Length, Hectometer>) = SquareHectometer.area(this, width)
@JvmName("kilometerTimesKilometer")
operator fun ScientificValue<MeasurementType.Length, Kilometer>.times(width: ScientificValue<MeasurementType.Length, Kilometer>) = SquareKilometer.area(this, width)
@JvmName("megameterTimesMegameter")
operator fun ScientificValue<MeasurementType.Length, Megameter>.times(width: ScientificValue<MeasurementType.Length, Megameter>) = SquareMegameter.area(this, width)
@JvmName("gigameterTimesGigameter")
operator fun ScientificValue<MeasurementType.Length, Gigameter>.times(width: ScientificValue<MeasurementType.Length, Gigameter>) = SquareGigameter.area(this, width)
...
operator fun ScientificValue<MeasurementType.Length, Inch>.times(width: ScientificValue<MeasurementType.Length, Inch>) = SquareInch.area(this, width)
@JvmName("footTimesFoot")
operator fun ScientificValue<MeasurementType.Length, Foot>.times(width: ScientificValue<MeasurementType.Length, Foot>) = SquareFoot.area(this, width)
@JvmName("yardTimesYard")
operator fun ScientificValue<MeasurementType.Length, Yard>.times(width: ScientificValue<MeasurementType.Length, Yard>) = SquareYard.area(this, width)
@JvmName("mileTimesMile")
operator fun ScientificValue<MeasurementType.Length, Mile>.times(width: ScientificValue<MeasurementType.Length, Mile>) = SquareMile.area(this, width)
