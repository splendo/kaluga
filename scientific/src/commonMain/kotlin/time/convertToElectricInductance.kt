...
import com.splendo.kaluga.scientific.electricResistance.times
import kotlin.jvm.JvmName

@JvmName("timeTimesAbohm")
infix operator fun <TimeUnit : Time> ScientificValue<MeasurementType.Time, TimeUnit>.times(resistance: ScientificValue<MeasurementType.ElectricResistance, Abohm>) = resistance * this
