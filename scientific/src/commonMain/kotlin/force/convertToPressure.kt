...
operator fun <AreaUnit : MetricArea> ScientificValue<MeasurementType.Force, Dyne>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = Barye.pressure(this, area)
@JvmName("dyneMultipleDivMetricArea")
operator fun <DyneUnit, AreaUnit : MetricArea> ScientificValue<MeasurementType.Force, DyneUnit>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) where DyneUnit : Force, DyneUnit : MetricMultipleUnit<MeasurementSystem.Metric, MeasurementType.Force, Dyne> = Barye.pressure(this, area)
@JvmName("metricForceDivMetricArea")
operator fun <ForceUnit : MetricForce, AreaUnit : MetricArea> ScientificValue<MeasurementType.Force, ForceUnit>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = Pascal.pressure(this, area)
...
operator fun <AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, Poundal>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = PoundSquareInch.pressure(this, area)
...
operator fun <AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, PoundForce>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = PoundSquareInch.pressure(this, area)
@JvmName("ounceForceDivImperialArea")
operator fun <AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, OunceForce>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = OunceSquareInch.pressure(this, area)
@JvmName("grainForceDivImperialArea")
operator fun <AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, GrainForce>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = OunceSquareInch.pressure(this, area)
...
operator fun <AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, Kip>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = KipSquareInch.pressure(this, area)
...
operator fun <AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, UsTonForce>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = USTonSquareInch.pressure(this, area)
...
operator fun <AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, ImperialTonForce>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = ImperialTonSquareInch.pressure(this, area)
@JvmName("imperialForceDivImperialArea")
operator fun <ForceUnit : ImperialForce, AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, ForceUnit>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = PoundSquareInch.pressure(this, area)
@JvmName("usCustomaryForceDivImperialArea")
operator fun <ForceUnit : USCustomaryForce, AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, ForceUnit>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = PoundSquareInch.usCustomary.pressure(this, area)
@JvmName("ukImperialForceDivImperialArea")
operator fun <ForceUnit : UKImperialForce, AreaUnit : ImperialArea> ScientificValue<MeasurementType.Force, ForceUnit>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = PoundSquareInch.ukImperial.pressure(this, area)
@JvmName("forceDivArea")
operator fun <ForceUnit : Force, AreaUnit : Area> ScientificValue<MeasurementType.Force, ForceUnit>.div(area: ScientificValue<MeasurementType.Area, AreaUnit>) = Pascal.pressure(this, area)
