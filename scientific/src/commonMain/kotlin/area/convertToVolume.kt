...
operator fun ScientificValue<MeasurementType.Area, SquareMeter>.times(height: ScientificValue<MeasurementType.Length, Meter>) = CubicMeter.volume(this, height)
@JvmName("squareNanometerTimesNanometer")
operator fun ScientificValue<MeasurementType.Area, SquareNanometer>.times(height: ScientificValue<MeasurementType.Length, Nanometer>) = CubicNanometer.volume(this, height)
@JvmName("squareMicrometerTimesMicrometer")
operator fun ScientificValue<MeasurementType.Area, SquareMicrometer>.times(height: ScientificValue<MeasurementType.Length, Micrometer>) = CubicMillimeter.volume(this, height)
@JvmName("squareMillimeterTimesMillimeter")
operator fun ScientificValue<MeasurementType.Area, SquareMillimeter>.times(height: ScientificValue<MeasurementType.Length, Millimeter>) = CubicMillimeter.volume(this, height)
@JvmName("squareCentimeterTimesCentimeter")
operator fun ScientificValue<MeasurementType.Area, SquareCentimeter>.times(height: ScientificValue<MeasurementType.Length, Centimeter>) = CubicCentimeter.volume(this, height)
@JvmName("squareDecimeterTimesDecimeter")
operator fun ScientificValue<MeasurementType.Area, SquareDecimeter>.times(height: ScientificValue<MeasurementType.Length, Decimeter>) = CubicDecimeter.volume(this, height)
@JvmName("squareDecameterTimesDecameter")
operator fun ScientificValue<MeasurementType.Area, SquareDecameter>.times(height: ScientificValue<MeasurementType.Length, Decameter>) = CubicDecameter.volume(this, height)
@JvmName("squareHectometerTimesHectometer")
operator fun ScientificValue<MeasurementType.Area, SquareHectometer>.times(height: ScientificValue<MeasurementType.Length, Hectometer>) = CubicHectometer.volume(this, height)
@JvmName("squareKilometerTimesKilometer")
operator fun ScientificValue<MeasurementType.Area, SquareKilometer>.times(height: ScientificValue<MeasurementType.Length, Kilometer>) = CubicKilometer.volume(this, height)
@JvmName("squareMegameterTimesMegameter")
operator fun ScientificValue<MeasurementType.Area, SquareMegameter>.times(height: ScientificValue<MeasurementType.Length, Megameter>) = CubicMegameter.volume(this, height)
@JvmName("squareGigameterTimesGigameter")
operator fun ScientificValue<MeasurementType.Area, SquareGigameter>.times(height: ScientificValue<MeasurementType.Length, Gigameter>) = CubicGigameter.volume(this, height)
...
operator fun ScientificValue<MeasurementType.Area, SquareInch>.times(height: ScientificValue<MeasurementType.Length, Inch>) = CubicInch.volume(this, height)
@JvmName("squareFootTimesFoot")
operator fun ScientificValue<MeasurementType.Area, SquareFoot>.times(height: ScientificValue<MeasurementType.Length, Foot>) = CubicFoot.volume(this, height)
@JvmName("squareYardTimesYard")
operator fun ScientificValue<MeasurementType.Area, SquareYard>.times(height: ScientificValue<MeasurementType.Length, Yard>) = CubicYard.volume(this, height)
@JvmName("squareMileTimesMile")
operator fun ScientificValue<MeasurementType.Area, SquareMile>.times(height: ScientificValue<MeasurementType.Length, Mile>) = CubicMile.volume(this, height)
@JvmName("acreTimesFoot")
operator fun ScientificValue<MeasurementType.Area, Acre>.times(height: ScientificValue<MeasurementType.Length, Foot>) = AcreFoot.volume(this, height)
